...
@section('content')
		<main id="uix-maincontent">
				...
				<div class="container">
					<div class="row">
						<div class="col-12">
							...
							<p>Liquid Distortion Effect 2</p>
							<hr>
						</div>
					</div>
					<!-- .row end -->
		   ...
		   <div role="banner" class="uix-advanced-slider-sp__wrapper">
			   <div class="uix-advanced-slider__outline uix-advanced-slider-sp uix-advanced-slider-sp--eff-liquid2" 
				  ...
				  data-filter-texture="../assets/images/dmaps/1024x512/gradient.png"
