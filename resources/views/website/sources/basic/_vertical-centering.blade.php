        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <div class="uix-relative">
                    <img src="{{$commonAssetUrl}}/website/assets/images/demo/test-img-big-3.jpg" alt="" width="100%">
        ...
        <div class="row">  
            <div class="col-md-6 offset-md-3">
                <div class="uix-relative--inline uix-relative--inline-clip" style="height: 400px;">
                    <img src="{{$commonAssetUrl}}/website/assets/images/demo/vertical-img.jpg" alt="" width="100%"  class="uix-parallax--el" data-transition="all 0.4s cubic-bezier(0, 0, 0.34, 0.96) 0s" data-speed="-0.2" style="margin-top: -100px;">
                    <div class="uix-v-align--absolute uix-t-c">
        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <div class="uix-relative" style="background: #F0F0F0; height: 400px;">
                    <img src="{{$commonAssetUrl}}/website/assets/images/demo/test-img-big-1.jpg" alt="" class="img-fluid w-100 h-100">
                    <div class="uix-v-align--absolute uix-t-c">
