		...
		<main id="uix-maincontent">
			...
			<section class="uix-spacing--s uix-spacing--no-top">
				<div class="uix-parallax uix-typo--color-white uix-height--50" data-fully-visible="false" data-offset-top="0" data-overlay-bg="rgba(0,0,0,.6)" data-skew="0" data-speed="0.3">
					<img class="uix-parallax__img" src="../assets/images/demo/test-img-big-1.jpg" alt="">
						...
						<div class="col-12">
								...
								<div class="uix-entry__content uix-list uix-list--normal uix-table uix-table--bordered">
									<div class="entry-image alignleft">
										<a href="#"><img src="../assets/images/demo/test-img-big-1.jpg" width="200" alt="Blog Single"></a>
									</div><!-- .entry-image end -->
                                    ...
                                    <P>
                                        <figure>
                                            <img src="../assets/images/demo/cool-slider-2.jpg" alt="image">	
									...
									<p><img src="../assets/images/demo/test-img-big-1.jpg" alt="big image" width="1024" height="682"></p>
									...
									<figure class="alignfull">
										<img src="../assets/images/demo/cool-slider-1.jpg" alt="big image" width="1024" height="682">		
									</figure>
									<p></p>
									<p>
										<ul>
										...
										<div class="comment uix-clearfix" id="comment-1">
											<div class="comment-meta">
												<div class="comment-avatar">
													<img src="../assets/images/demo/avatar.jpg" alt="avatar">
												</div>
