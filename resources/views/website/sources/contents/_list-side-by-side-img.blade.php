 		...
 		<main id="uix-maincontent">
			...
			<section class="uix-spacing--s uix-spacing--no-bottom">
				<div class="container">
					<div class="row">
						<div class="col-12">
							<h3>Side by Side List With Photo</h3>
							<hr>
						</div>
					</div>
					<!-- .row end -->
									...
									<div class="uix-list-abreast-img">
										<div class="uix-list-abreast-img__item">
											<div class="uix-list-abreast-img__item__left">
												<div class="uix-list-abreast-img__item__img"> 
													<img src="../assets/images/demo/avatar-r-1.jpg" alt="Jone Smmith"> 
												</div>
											</div>
										...
										<div class="uix-list-abreast-img__item">
											<div class="uix-list-abreast-img__item__left">
												<div class="uix-list-abreast-img__item__img"> 
													<img src="../assets/images/demo/avatar-r-2.jpg" alt="Donny Kiu" > 
												</div>
											</div>
											<div class="uix-list-abreast-img__item__right">
												<h4>Donny Kiu</h4>
