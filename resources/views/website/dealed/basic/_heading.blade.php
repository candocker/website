    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                  ...
                  <br><br>            
                  <h2 class="uix-heading--fill" data-bg='{"src":"{{$commonAssetUrl}}/website/assets/images/demo/test-img-big-4.jpg","position":"top left","size":"cover","repeat":"no-repeat","fill":true,"offsetTop":0,"parallax":0}'>SHOW IMAGE UNDER TEXT</h2> 
                  <br><br>
