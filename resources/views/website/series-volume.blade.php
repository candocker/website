...
<section class="uix-spacing--s uix-spacing--no-bottom">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h3>{{$datas['seriesData']['name']}}</h3>
                <p>{{$datas['seriesData']['brief']}}</p>
                <hr>
            </div>
        </div>
    </div>
...
<section class="uix-spacing--s">
    <div class="container">
        <div class="row">
            <div class="col-12">
                @include('website.modules.table._table-responsive', ['data' => $datas['graphicDatas'], 'headers' => $datas['headers']['volume'], 'type' => 'volume'])
            </div>
        </div>
