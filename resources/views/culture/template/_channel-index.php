        ...
        <div class="inner">
          <div class="l">
            <a href="{{= data.data[0].linkUrl}}">
              ...
              {{?}}
              <div class="img_box" style="{{= !data.data[0].title && !data.data[0].subTitle ?'width:100%;height:100%;margin:0;':'' }}">
                <img src="{{= data.data[0].imgUrl}}" onerror="this.style.width=0;" alt="" style="{{= !data.data[0].title && !data.data[0].subTitle ?'object-fit: cover;-o-object-fit: cover;width: 100%;height: 100%;':'' }}">
              </div>
            </a>
          </div>
          <div class="r">
            <div class="box">
              <a href="{{= data.data[1].linkUrl}}">
                ...
                {{?}}
                <div class="img_box" style="{{= !data.data[1].title && !data.data[1].subTitle ?'width:100%;height:100%;margin:0;':'' }}">
            ...
            <div class="box">
              <a href="{{= data.data[2].linkUrl}}">
                ...
                {{?}}
                <div class="img_box" style="{{= !data.data[2].title && !data.data[2].subTitle ?'width:100%;height:100%;margin:0;':'' }}">
