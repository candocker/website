...
<table width="92%" border="1" align="center" cellspacing="0" class="indextable">
    ...
    <tbody>
        ...
        @endif
        <td class="index_left_td"><a @if (!isset($infos[$pCode]['isLost']))href="/newshow-{{$datas['bookCode']}}-{{$pCode}}"@endif>@if (!isset($datas['bookData']['onlyName'])){{$pCode}}@endif {{$infos[$pCode]['name']}}</a></td>
