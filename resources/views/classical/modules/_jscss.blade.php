...
@switch($view)
@case('detail')
<link rel="stylesheet" href="{{$commonAssetUrl}}/classical/css/dd99b-8811.css?v=36" type="text/css">
...
@break
@default
<link rel="stylesheet" href="{{$commonAssetUrl}}/classical/css/3ade8-3930.css?v=36" type="text/css">
