...
return [
    'chapters' => [
        [
            'content' => [
                '子曰，“武王、周公，其达(1)孝矣乎。”',
                '“夫孝者，善继人(2)之志，善述人之事者也。”',
                '“春秋，修其祖庙(3)，陈其宗器(4)，设其裳衣(5)，荐其时食(6)。”',
                '“宗庙之礼，所以序昭穆(7)也。序爵(8)，所以辨贵贱也。序事(9)，所以辨贤也。旅酬下为上(10，所以达贱也(11)。燕毛(12)所以序齿(13)也。”',
                '“践其位(14)，行其礼，奏其乐，敬其所尊，爱其所亲，事死如事生，事亡如事存，孝之至也。”',
                '“郊社之礼(15)，所以事上帝也。宗庙之礼，所以祀乎其先也。明乎郊社之礼，褅尝(16)之义，治国(17)其如示诸掌乎。”',
            ],
            'notes' => [
                '(1)达：通“大”字。',
                '(2)人：指祖先。下面“人”字同此意思。',
