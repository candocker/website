...
'chapters' => [
    [
        'content' => [
            '白闻天下谈士(1)相聚而言曰：“生不用封万户侯(2)，但愿一识韩荆州。”何令人之景慕(3)，一至于此耶!岂不以有周公之风，躬吐握之事(4)，使海内豪俊，奔走而归之，一登龙门(5)，则声价十倍!所以龙蟠凤逸(6)之士，皆欲收名定价于君侯(7)。愿君侯不以富贵而骄之、寒贱而忽之，则三千之中有毛遂，使白得颖脱而出，即其人焉(8)。',
        ],
        'notes' => [
            ...
            '(7)君侯：对尊贵者的敬称，尤指上级。',
            '(8)毛遂：战国时赵国平原君食客。秦围邯郸，赵王使平原君求救于楚，毛遂请求随同前往，自荐说：“臣乃今日请处囊中耳。使遂早得处囊中，乃颖脱而出，非特其末见而已。”随从至楚，果然说服了楚王，使其同意发兵。平原君于是奉他为上客(见《史记·平原君虞卿列传》)。颖(yǐng)：指锥芒。颖脱而出，喻才士若获得机会，必能充分显示其才能。',
        ],
        'vernacular' => [
    ...
    [
        'content' => [
            '白，陇西(1)布衣，流落楚、汉。十五好剑术，遍干诸侯(2)。三十成文章，历抵卿相(3)。虽长不满七尺，而心雄万夫。皆王公大人许与气义。此畴曩心迹，安敢不尽于君侯哉!',
            '君侯制作侔神明，德行动天地，笔参造化，学究天人(4)。幸愿开张心颜，不以长揖见拒(5)。必若接之以高宴，纵之以清谈(6)，请日试万言，倚马可待(7)。今天下以君侯为文章之司命，人物之权衡(8)，一经品题，便作佳士。而君侯何惜阶前盈尺之地(9)，不使白扬眉吐气，激昂青云耶?',
        ],
        'notes' => [
            '(1)陇西：古郡名，始置于秦，治所在狄道(今甘肃临洮)。李白自称十六国时凉武昭王李暠之后，李暠为陇西人。布衣：平民。楚汉：当时李白安家于安陆(今属湖北)，往来于襄阳、江夏等地。',
            '(2)干：干谒，对人有所求而请见。诸侯：此指地方长官。',
            '(3)历：普遍。抵：拜谒，进见。卿相：指中央朝廷高级官员。畴曩(chóunǎng)：往日。',
            '(4)制作：指文章著述。侔(móu)：相等，齐同。东汉崔瑗《张平子碑》：“数术穷天地，制作侔造化。”。参，参与。造化：自然的创造化育。天人：天道和人道。南朝梁钟嵘《诗品序》：“文丽日月，学究天人。”',
            '(5)开张：开扩，舒展。长揖：相见时拱手高举自上而下以为礼。',
            '(6)清谈：汉末魏晋以来，士人喜高谈阔论，或评议人物，或探究玄理，称为清谈。',
            '(7)倚马可待：喻文思敏捷。东晋时袁宏随同桓温北征，受命作露布文(檄文、捷书之类)，他倚马前而作，手不辍笔，顷刻便成，而文极佳妙。',
            '(8)司命：原为神名，掌管人之寿命。此指判定文章优劣的权威。权：秤锤;衡：秤杆。此指品评人物的权威。',
            '(9)惜阶前盈尺之地：意即不在堂前接见我。',
        ],
        'vernacular' => [
    ...
    [
        'content' => [
            '昔王子师(1)为豫州，未下车，即辟荀慈明，既下车，又辟孔文举;山涛(2)作冀州，甄拔三十余人，或为侍中、尚书，先代所美。而君侯亦荐一严协律，入为秘书郎，中间崔宗之、房习祖、黎昕、许莹之徒(3)，或以才名见知，或以清白见赏。白每观其衔恩抚躬(4)，忠义奋发，以此感激，知君侯推赤心于诸贤腹中(5)，所以不归他人，而愿委身国士(6)。傥(7)急难有用，敢效微躯。',
            '且(8)人非尧舜，谁能尽善?白谟猷(9)筹画，安能自矜?至于制作，积成卷轴(10)，则欲尘秽视听(11)。恐雕虫小技(12)，不合大人。若赐观刍荛(13)，请给纸墨，兼之书人，然后退扫闲轩(14)，缮写呈上。庶青萍、结绿，长价于薛、卞之门(15)。幸惟下流(16)，大开奖饰(17)，惟君侯图之。',
        ],
        'notes' => [
            '(1)王子师：东汉王允字子师，灵帝时豫州刺史(治所在沛国谯县，今安徽亳县)，征召荀爽(字慈明，汉末硕儒)、孔融(字文举，孔子之后，汉末名士)等为从事。全句原出西晋东海王司马越《与江统书》。',
            '(2)山涛：字巨源，西晋名士，竹林七贤之一。为翼州(今河北高邑西南)刺史时，搜访贤才，甄拔隐屈。侍中、尚书：中央政府官名。',
            '(3)严协律：名不详。协律，协律郎，属太常寺，掌校正律吕。秘书郎：属秘书省，掌管中央政府藏书。崔宗之：李白好友，开元中入仕，曾为起居郎、尚书礼部员外郎、礼部郎中、右司郎中等职，与孟浩然、杜甫亦曾有交往。房习祖：不详。黎昕：曾为拾遗官，与王维有交往。许莹：不详。',
            '(4)抚躬：犹言抚膺、抚髀，表示慨叹。抚，拍。',
            '(5)推赤心于诸贤腹中：《后汉书·光武本纪》：“萧王(刘秀)推赤心置人腹中。”',
            '(6)国士：国中杰出的人。',
            '(7)傥：同“倘”。',
            '(8)且：提起连词。',
            '(9)谟猷(yóu)：谋画，谋略。',
            '(10)卷轴：古代帛书或纸书以轴卷束。',
            '(11)尘秽视听：请对方观看自己作品的谦语。',
            '(12)雕虫小技：西汉扬雄称作赋为“童子雕虫篆刻”，“壮夫不为”(见《法言·吾子》)。虫书、刻符为当时学童所习书体，纤巧难工。此处是作者自谦之词。',
            '(13)刍荛(chúráo)：割草为刍，打柴为荛，刍荛指草野之人。也是作者用以谦称自己的作品。',
            '(14)闲轩：静室。',
            '(15)青萍：宝剑名。结绿：美玉名。薛：薛烛，古代善相剑者，见《越绝书外传·记宝剑》。卞：卞和，古代善识玉者，见《韩非子·和氏》。',
            '(16)惟：念。下流：指地位低的人。惟，一作“推”。',
            '(17)奖饰：奖励称誉。',
        ],
        'vernacular' => [
