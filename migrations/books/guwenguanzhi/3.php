...
'chapters' => [
    [
        'content' => [
            '卫庄公娶于齐东宫得臣之妹(1)，曰庄姜(2)。美而无子，卫人所为赋《硕人》(3)也。又娶于陈(4)，曰厉妫(5)。生孝伯，蚤(6)死。其娣(7)戴妫生桓公(8)，庄姜以为己子。',
            '公子州吁，嬖人(9)之子也。有宠而好兵，公弗禁，庄姜恶之。',
        ],
        'notes' => [
            '(1)卫：国名，姬姓，在今河南淇县一带。齐：国名，姜姓，在今山东北部、中部地区。东宫：太子的居所。',
            '(2)庄姜：卫庄公的夫人，“庄”是她丈夫的谥号，“姜”则是她娘家的姓，故称庄姜。',
            '(3)硕人：典出《诗经·卫风》中的一篇，乃歌颂庄姜美丽的诗篇。',
            '(4)陈：国名，妫姓在今河南东部及安徽西部。',
            '(5)厉妫(guī)：“厉”和下文“戴妫”的“戴”均为谥号，“妫”是娘家的姓。',
            '(6)蚤：通”早“。',
            '(7)娣：妹。古时诸侯娶妻，妹可随姊同嫁。',
            '(8)桓公：名完，在位十六年，后为州吁所杀。',
            '(9)嬖(bì)人：出身低贱而受宠的人，这里指卫庄公的宠妾。',
        ],
        'vernacular' => [
    ...
    [
        'content' => [
            '石碏(1)谏曰：“臣闻爱子，教之以义方(2)，弗纳于邪。骄奢淫佚(3)，所自邪也。四者之来，宠禄过也。将立州吁，乃定之矣;若犹未也，阶(4)之为祸。夫宠而不骄，骄而能降，降而不憾，憾而能眕(5)者，鲜(6)矣。且夫贱妨贵，少陵(7)长，远间亲，新间旧，小加大，淫破义，所谓六逆也。君义，臣行，父慈，子孝，兄爱，弟敬，所谓六顺也。去(8)顺效逆，所以速(9)祸也。君人者，将祸是(10)务去，而速之，无乃(11)不可乎?”弗听。',
            '其子厚与州吁游，禁之，不可。桓公立(12)，乃老(13)。',
        ],
        'notes' => [
            '(1)石碏(què)：卫国大夫。',
            '(2)义方：为人行事的规范。',
            '(3)佚(yì)：这里指逸乐。',
            '(4)阶：阶梯，这里用作动词，指一步步引向。',
            '(5)眕(zhěn)：自安自重，忍耐而不轻举妄动。',
            '(6)鲜(xiǎn)：少见。',
            '(7)陵：欺侮。',
            '(8)去：抛弃。',
            '(9)速：招致。',
