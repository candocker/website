...
[
    'content' => [
        '臣伏见天后时(1)，有同州下邽人徐元庆者，父爽为县吏赵师韫所杀(2)，卒能手刃父仇，束身归罪。当时谏臣陈子昂建议诛之而旌其闾(3);且请“编之于令，永为国典(4)”。臣窃独过(5)之。',
        '臣闻礼(6)之大本，以防乱也。若曰无为贼虐(7)，凡为子者杀无赦。刑之大本，亦以防乱也。若曰无为贼虐，凡为理者杀无赦。其本则合，其用则异，旌与诛莫得而并焉。诛其可旌，兹谓滥;黩刑(8)甚矣。旌其可诛，兹谓僭(9);坏礼甚矣。果以是示于天下，传于后代，趋义者不知所向，违害者不知所立，以是为典可乎?盖圣人之制(10)，穷理以定赏罚，本情以正褒贬，统于一而已矣。',
        '向使刺谳(11)其诚伪，考正其曲直，原(12)始而求其端，则刑礼之用，判然离矣。何者?若元庆之父，不陷于公罪(13)，师韫之诛，独以其私怨，奋其吏气，虐于非辜，州牧(14)不知罪，刑官不知问，上下蒙冒(15)，吁号不闻;而元庆能以戴天为大耻，枕戈为得礼(16)，处心积虑，以冲仇人之胸，介然(17)自克，即死无憾，是守礼而行义也。执事者宜有惭色，将谢之(18)不暇，而又何诛焉?',
        '其或元庆之父，不免于罪，师韫之诛，不愆(19)于法，是非死于吏也，是死于法也。法其可仇乎?仇天子之法，而戕奉法之吏，是悖骜而凌上也(20)。执而诛之，所以正邦典(21)，而又何旌焉?',
    ...
    'notes' => [
        ...
        '(2)同州：唐代州名，辖境相当于今陕西省大荔、合阳、韩城、澄城、白水等县一带。下邽（guī）：县名，今陕西省渭南县。赵师韫(yùn)：当时的下邽县尉。',
        '(3)陈子昂：字伯玉，梓州射洪（今四川省射洪县）人。武后时曾任右拾遗，为谏诤之官。旌(jīng)：表彰。闾：里巷的大门。',
        '(4)国典：国法。',
        '(5)过：错误，失当。',
        '(6)礼：封建时代道德和行为规范的泛称。',
        '(7)贼虐：行凶杀人。',
        ...
        '(14)州牧：州的行政长官。',
        '(15)蒙冒(mào)：蒙蔽，包庇。',
        '(16)戴天：头上顶着天，意即和仇敌共同生活在一个天地里。《礼记·曲礼上》：“父之仇，弗与共戴天。”枕戈：睡觉时枕着兵器。',
        '(17)介然：坚定的样子。自克：自我控制。',
        '(18)谢之：向他道歉认错。',
        '(19)愆(qiān)：过错。',
        '(20)戕(qiāng)：杀害。悖(bèi)骜(ào)：桀骜不驯。悖，违背。骜，傲慢。',
        '(21)邦典：国法。',
        '(22)《周礼》：又名《周官》，《周官经》，儒家经典之一，内容是汇编周王室的官制和战国时代各国的制度等历史资料。',
        '(23)调人：周代官名，负责排解纠纷的官员。',
        '(24)《春秋公羊传》：即《公羊传》，《春秋》三传之一。子夏弟子公羊高作。',
        '(25)推刃：往来相杀。',
        '(26)斯狱：这种案件。',
    ],
    'vernacular' => [
