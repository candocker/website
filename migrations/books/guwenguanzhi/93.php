...
[
    'name' => '上篇-1',
    'content' => [
        '秦孝公据崤函之固(1)，拥雍州之地，君臣固守以窥周室(2)，有席卷天下，包举宇内，囊括四海之意，并吞八荒之心(3)。当是时也，商君佐之(4)，内立法度，务耕织，修守战之具;外连衡而斗诸侯(5)。于是秦人拱手而取西河之外(6)。',
        '孝公既没，惠文、武、昭襄蒙故业，因遗策，南取汉中，西举巴、蜀，东割膏腴之地，北收要害之郡(7)。诸侯恐惧，会盟而谋弱秦，不爱珍器重宝肥饶之地，以致天下之士，合从缔交，相与为一(8)。当此之时，齐有孟尝，赵有平原，楚有春申，魏有信陵。此四君者，皆明智而忠信，宽厚而爱人，尊贤而重士，约从离衡，兼韩、魏、燕、楚、齐、赵、宋、卫、中山之众(9)。于是六国之士，有宁越、徐尚、苏秦、杜赫之属为之谋(10)，齐明、周最、陈轸、召滑、楼缓、翟景、苏厉、乐毅之徒通其意(11)，吴起、孙膑、带佗、倪良、王廖、田忌、廉颇、赵奢之伦制其兵(12)。尝以十倍之地，百万之众，叩关(13)而攻秦。秦人开关延敌，九国之师，逡巡而不敢进(14)。秦无亡矢遗镞之费(15)，而天下诸侯已困矣。于是从散约败，争割地而赂秦。秦有余力而制其弊，追亡逐北(16)，伏尸百万，流血漂橹。因利(17)乘便，宰割天下，分裂山河。强国请服，弱国入朝。延及孝文王、庄襄王，享国(18)之日浅，国家无事。',
    ],
    'notes' => [
        '(1)秦孝公：生于公元前381年，死于公元前338年，战国时秦国的国君，名渠梁。穆公十五世孙。他任用商鞅变法，使秦富国强兵。崤函(xiáo hán)：崤山和函谷关。崤山，在函谷关的东边。函谷关，在河南省灵宝县。固，险要的地理位置。',
        '(2)雍州：包括今陕西省中部和北部、甘肃省除去东南部的大部分地区、青海省的东南部和宁夏回族自治区一带地方。周室：这里指代天子之位的权势，并非实指周王室。战国初期，周王室已经十分衰弱，所统治的地盘只有三四十座城池，三万多人口。',
        '(3)席卷天下：与下文“包举宇内、囊括四海、并吞八荒”是同义铺排。席，像用席子一样，名词作状语。下文的“包”“囊”同此。八荒：原指八方荒远的偏僻地方，此指代“天下”。',
        '(4)商君：即商鞅，约生于公元前390年，死于前338年。战国时卫人。姓公孙，名鞅。因封于商，号曰商君。先仕魏，为魏相公叔痤家臣。痤死后入秦，相秦十九年，辅助秦孝公变法，使秦国富强。孝公死，公子虔等诬陷鞅谋反，车裂死。',
        '(5)外：对国外。连衡：也作“连横”，是一种离间六国，使它们各自同秦国联合，从而实施各个击破的策略。“连衡”一句为虚笔，张仪相秦始于惠文王十年，即公元前328年，是商鞅死后十年的事。斗诸侯：使诸侯自相争斗。斗，使动用法。',
        '(6)拱手：两手合抱，形容毫不费力。西河：又称河西，今陕西东部黄河西岸地区。秦孝公二十二年（公元前340年），商鞅伐魏，魏使公子为将而击之。商鞅遗书公子，愿与为好会而罢兵。会盟既已，商鞅虏公子而袭夺其军。其后十年间，魏屡败于秦，魏王恐，乃使使割西河之地献于秦以和。',
        '(7)没：通“殁”，死。惠文、武、昭襄：即惠文王、武王、昭襄王。惠文王是孝公的儿子，武王是惠文王的儿子，昭襄王是武王的异母弟。因：动词，沿袭。膏腴(gāo yú)：指土地肥沃。要害之郡：指政治、经济、军事上都非常重要的地区。',
        '(8)爱：吝惜，吝啬。致：招致，招纳。合从：与秦“连横”之策相对，是联合六国共同对付秦国的策略。从，通“纵”。',
        '(9)四君：指齐孟尝君田文、赵平原君赵胜、楚春申君黄歇、魏信陵君魏无忌。他们都是当时仅次于国君的当政者，皆以招揽宾客著称。约，结。离，使离散。衡，通“横”。兼，兼并、统一.。',
        '(10)徐尚：宋人。苏秦：洛阳人，是当时的“合纵长”。杜赫：周人。',
        '(11)齐明：东周臣。周最：东周君儿子。陈轸：楚人。召滑(shào)：楚臣。⑨楼缓：魏相。⑩翟景：魏人。苏厉：苏秦的弟弟.乐毅：燕将.',
        '(12)吴起：魏将，后入楚。孙膑：齐将。带佗：楚将。倪良、王廖：都是当时的兵家。田忌：齐将。廉颇、赵奢：赵将。制：统领、统帅。',
        '(13)叩关：攻打函谷关。叩，击。',
        '(14)九国之师，逡巡而不敢进：九国，就是上文的韩、魏、燕、楚、齐、赵、宋、卫、中山。逡巡(qūn xún)，有所顾虑而徘徊或不敢前进。据《史记·六国表》载，并没有“九国之师”齐出动的情况，“秦人开关延敌，九国之师，逡巡而不敢进”不尽合历史事实。',
        '(15)亡：丢失，丢掉。镞：箭头。',
        '(16)制：制裁，制服。弊：通“敝”，困敝、疲敝。亡：逃亡的军队，在此用作名词。北：败北的军队，名词。伏尸百万：这说的不是一次战役的死亡人数。秦击六国杀伤人数史书皆有记载，如前293年击韩伊阙，斩首24万；前260年，破赵长平军，杀卒45万。',
        '(17)因：趁着，介词。利：有利的形势，用作名词。',
        '(18)享国：帝王在位的年数。',
    ],
    'vernacular' => [
...
[
    'name' => '上篇-2',
    'content' => [
        '及至始皇，奋六世之余烈，振长策而御宇内(19)，吞二周而亡诸侯，履至尊而制六合，执敲扑而鞭笞天下，威振四海(20)。南取百越之地，以为桂林、象郡;百越之君，俯首系颈，委命下吏(21)。乃使蒙恬北筑长城而守藩篱(22)，却匈奴七百余里。胡人不敢南下而牧马，士不敢弯弓而报怨。于是废先王之道，焚百家之言，以愚黔首(23);隳名城，杀豪杰，收天下之兵，聚之咸阳，销锋镝，铸以为金人十二(24)，以弱天下之民。然后践华为城，因河为池，据亿丈之城，临不测之渊(25)，以为固。良将劲弩守要害之处，信臣精卒陈利兵而谁何(26)。天下已定，始皇之心，自以为关中之固，金城千里，子孙帝王万世之业也(27)。',
        '始皇既没，余威震于殊俗(28)。然陈涉瓮牖绳枢之子，氓隶之人，而迁徙之徒也(29);才能不及中人(30)，非有仲尼、墨翟之贤，陶朱、猗顿之富;蹑足行伍之间，而倔起阡陌之中(31)，率疲弊之卒，将数百之众，转而攻秦，斩木为兵，揭竿为旗，天下云集响应，赢粮而景从(32)。山东豪俊遂并起而亡秦族矣。',
        '且夫天下非小弱也(33)，雍州之地，崤函之固，自若也。陈涉之位，非尊于齐、楚、燕、赵、韩、魏、宋、卫、中山之君也;锄耰棘矜，非铦于钩戟长铩也(34);谪戍之众，非抗于九国之师也;深谋远虑，行军用兵之道，非及(35)向时之士也。然而成败异变，功业相反，何也?试使山东之国与陈涉度长絜(36)大，比权量力，则不可同年而语矣。然秦以区区之地，致万乘(37)之势，序八州而朝同列，百有余年矣(38);然后以六合为家，崤函为宫;一夫作难而七庙隳，身死人手，为天下笑者，何也?仁义不施而攻守之势异也。',
    ],
    'notes' => [
        '(19)六世：指秦孝公、惠文王、武王、昭襄王、孝文王、庄襄王。御：驾御，统治。',
        '(20)二周：在东周王朝最后的周赧王时，东西周分治。西周都于河南东部旧王城，东周则都巩，史称东西二周。西周灭于秦昭襄王五十一年，东周灭于秦庄襄王元年，不是始皇时事，作者只是为了行文方便才这样写的。履至尊：登帝位。制：控制。振：通“震”，震惊（粤教版已直接用所通假的字）。',
        '(21)南：向南。百越：古代越族居住在江、浙、闽、粤各地，每个部落都有名称，而统称百越，也叫百粤。俯首系颈：意思是愿意顺从投降。系颈，颈上系绳，表示投降。下吏：交付司法官吏审讯。',
        '(22)北:在北方，方位名词作状语。藩篱：比喻边疆上的屏障。藩，篱笆。',
        '(23)先王：本文指的是秦自孝公以来六代君王。先，已死去的长辈。焚百家之言：指秦始皇焚书坑儒。百家之言，诸子百家各学派的著作。言，言论，这里指著作。',
        '(24)隳名城：毁坏高大的城墙。销锋镝：销毁兵器。销，熔化金属。锋，兵刃。镝，箭头。金人：《史记·秦始皇本纪》：“收天下兵，聚之咸阳，销以为钟鐻，金人十二，重各千斤，置廷宫中。”弱：使（天下百姓）衰弱。',
        '(25)亿丈之城：指华山。不测之渊，指黄河。',
        '(26)良将劲弩守要害之处，信臣精卒陈利兵而谁何：这两个句子用了互文的手法，应当理解为，“良将劲弩、信臣精卒，守要害之处，陈利兵而谁何”。信臣，可靠的大臣。谁何，呵问他是谁，就是缉查盘问的意思。何，通“呵”，呵喝。',
        '(27)关中：秦以函谷关为门户，关中即指秦雍州地。金城：坚固的城池。金，比喻坚固。子孙帝王：子子孙孙称帝称王。帝王，名词活用动词',
        '(28)殊俗：不同的风俗，指边远的地方。',
        '(29)瓮牖绳枢：以破瓮作窗户，用草绳替代户枢系门板，形容家里贫穷。瓮，用瓮做。牖，窗户。绳，用绳子系。枢，门扇开关的枢轴。氓隶：农村中地位低下的人。陈涉少时为人佣耕，所以称他为“氓隶”。氓，古时指农村居民。隶，奴隶。迁徙之徒：被征发戍边的人，指陈涉在秦二世元年被征发戍守渔阳。',
        '(30)中人：一般人。',
        '(31)蹑足行伍(háng wǔ)：置身于戍卒的队伍中。蹑足，蹈，用脚踏地，这里有“置身于……”的意思。行伍，古代军队编制，以五人为伍，二十五人为行，故以“行伍”代指军队。倔：通“崛”，突起（粤教版已直接用所通假的字）。阡陌(qiān mò)， 本是田间小道，这里代指民间。',
        '(32)赢粮而景从：担着干粮如影随形地跟着。赢，担负。景，同“影”。',
        '(33)且夫：复合虚词，表递进，相当“再说”“而且”。小弱，变小变弱。',
        '(34)耰：通“耰”（粤教版已直接用所通假的字），古时的一种碎土平田用的农具，似耙而无齿。棘：酸枣木。矜：矛柄，这里指木棍。铦：锋利。钩：短兵器，似剑而曲。戟：以戈和矛合为一体的长柄兵器。铩：长矛。',
        '(35)及：动词，赶得上，追得上。',
        '(36)絜：衡量。',
        '(37)万乘：兵车万辆，表示军事力量强大。周制，天子地方千里，出兵车万乘，故又以万乘代指天子。乘（shèng），古时车辆叫乘。',
        '(38)序八州：给八州按次第排列座次。序，座次、次序，这里是排列次序的意思。八州，指兖州、冀州、青州、徐州、豫州、荆州、扬州、梁州。古时天下分九州，秦居雍州，六国分别居于其他八州。朝同列：使六国诸侯都来朝见。朝，使……来朝拜。同列，同在朝班，此指六国诸侯，秦与六国本来都是周王朝的同列诸侯。有：通“又”，用于连接整数和零数。',
    ],
    'vernacular' => [
...
[
    'name' => '中篇-1',
    'content' => [
        '秦灭周祀，并海内，兼诸侯，南面称帝，以养四海(1)。天下之士，斐然向风(2)。若是，何也?曰：近古之无王者久矣。周室卑微，五霸既灭，令不行于天下。是以诸侯力政，强凌弱，众暴寡(3)，兵革不休，士民罢弊。今秦南面而王天下，是上有天子也。既元元之民冀得安其性命(4)，莫不虚心而仰上。当此之时，专威(5)定功，安危之本，在于此矣。',
        '秦王怀贪鄙之心，行自奋之智，不信功臣，不亲士民，废王道而立私爱，焚文书而酷刑法，先诈力而后仁义(6)，以暴虐为天下始。夫兼并者高诈力，安危者贵顺权(7)，此言取与守不同术也。秦离(8)战国而王天下，其道不易，其政不改，是其所以取之守之者无异也。孤独而有之，故其亡可立而待也。借使秦王论上世之事，并殷、周之迹，以制御其政，后虽有淫骄之主(9)，犹未有倾危之患也。故三王之建天下，名号显美，功业长久。',
    ],
    'notes' => [
        '(1)南面：古代以坐北面南为尊位，帝王的座位面向南，所以称居帝位为“南面”。养：养育，统治.',
        '(2)斐然：顺服的样子。斐，通“靡”。向风：归顺。',
        '(3)卑微，衰败。力政：以武力征伐。政，通“征”。暴，欺侮。',
        '(4)既：当是“则”的意思。《会注考证》引李笠曰：“当依《新书》作‘即’。”元元，平民百姓。冀：希望。',
        '(5)专威：独擅威势。',
        '(6)王道：古时指以仁义统治天下的政策。文书：诗书古籍。酷刑法，使刑法严酷。先：把……放在前头。后，把……放在后头。',
        '(7)高：以为高，重视。贵：以为贵，重视。顺权，顺时权变。',
        '(8)离：经历。',
        '(9)借使：假使。制御：统治，控制。淫骄：荒淫骄横。',
    ],
    'vernacular' => [
...
[
    'name' => '中篇-2',
    'content' => [
        '今秦二世立，天下莫不引领而观其政。夫寒者利裋褐，而饥者甘糟糠(10)。天下嚣嚣(11)，新主之资也。此言劳民之易为仁也。向使二世有庸主之行而任忠贤，臣主一心而忧海内之患，缟素而正先帝之过;裂地分民以封功臣之后，建国立君以礼天下;虚囹圄而免刑戮，去收孥污秽之罪(12)，使各反其乡里;发仓廪，散财币，以振孤独穷困之士;轻赋少事，以佐百姓之急;约法省刑(13)，以持其后，使天下之人皆得自新，更节修行，各慎其身;塞万民之望，而以盛德与天下，天下息矣。即四海之内皆欢然各自安乐其处，惟恐有变。虽有狡害(14)之民，无离上之心，则不轨之臣无以饰其智，而暴乱之奸弭矣。',
        '二世不行此术，而重以无道：坏宗庙与民，更始作阿房之宫;繁刑严诛，吏治刻深;赏罚不当，赋敛无度。天下多事，吏不能纪;百姓困穷，而主不收恤。然后奸伪并起，而上下相遁;蒙罪者众，刑戮相望于道，而天下苦之。自群卿以下至于众庶，人怀自危之心，亲处穷苦之实，咸不安其位，故易动也。是以陈涉不用汤、武之贤，不借公侯之尊，奋臂于大泽(15)，而天下响应者，其民危也。',
        '故先王者，见终始不变，知存亡之由。是以牧民(16)之道，务在安之而已矣。下虽有逆行之臣，必无响应之助。故曰：“安民可与为义，而危民易与为非”，此之谓也。贵为天子，富有四海(17)，身在于戮者，正之非也。是二世之过也。',
    ],
    'notes' => [
        '(10)糟糠：酒滓、谷皮等粗劣食物，贫者以之充饥',
        '(11)天下嚣嚣：天下百姓苦苦哀叫。',
        '(12)收孥(nú)：古时，一人犯法，妻子连坐，没为官奴婢，谓之收孥。',
        '(13)约法省刑：是汉初的立法原则之一，是为了缓和社会矛盾而实施的立法原则。',
        '(14)狡害：狡猾为害。',
        '(15)奋臂：振臂而起。大泽：大泽乡，是陈胜、吴广起义的地点。',
        '(16)牧民：治民。',
        '(17)富有四海：享有全国的一切财富，旧时用以形容帝王。四海，指全国。',
    ],
    'vernacular' => [
