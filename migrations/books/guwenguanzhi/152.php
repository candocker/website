...
[
    'content' => [
        '自西山道口径北，逾黄茅岭而下(1)，有二道：其一西出(2)，寻之无所得;其一少北而东(3)，不过四十丈，土断而川分，有积石横当其垠(4)。其上为睥睨、梁欐之形，其旁出堡坞，有若门焉(5)。窥(6)之正黑，投以小石，洞然有水声，其响之激越，良久乃已(7)。环之可上，望甚远(8)，无土壤而生嘉树美箭，益奇而坚(9)，其疏数偃仰，类智者所施设也(10)。',
        '噫!吾疑造物者(11)之有无久矣。及是，愈以为诚有(12)。又怪其不为之中州，而列是夷狄，更千百年不得一售其伎，是固劳而无用(13)。神者傥不宜如是，则其果无乎(14)?或曰：“以慰夫贤而辱于此者(15)。”或曰：“其气之灵，不为伟人,而独为是物，故楚之南少人而多石(16)。”是二者，余未信之。',
    ],
    'notes' => [
        '(1)径北：一直往北。逾：越过。黄茅岭：在今湖南省零陵县城西面。',
        '(2)西出：路向西伸去。',
        '(3)少(shāo)北而东：稍向北又向东去。少，通“稍”。',
        '(4)土断而川分：土路中断，出现分流的河水。横当其垠(yín)：横着挡在路的尽头。',
        '(5)睥睨(pì nì)：城墙上如齿状的矮墙。梁欐(lì)：栋梁，这里指架支着的梁栋。欐，栋，正梁。堡坞(wù)：小城堡，此处是指由山石天然形成的。因此作者称其“小石城山”。',
        '(6)窥：注意，留心。',
        '(7)洞然：深深的样子。激越：声音高亢清远。已：停止。',
        '(8)环：绕道而行。望甚远：“望之甚远”的意思。',
        '(9)箭：指竹子。益：更加。',
        '(10)“其疏数”二句：意思是，那些嘉树美箭，疏密相宜，起伏有致，好像是聪明人精心设置的。数(cù)，密。堰(yàn)，倒伏。类：好像。',
        '(11)造物者：指创世上帝。',
        '(12)愈：更是。诚：确实是，的确是。',
        '(13)“又怪其”四句：意思是说，又奇怪“造物者”不把小石城山安排在中原，反而陈设在这偏僻的蛮夷地区，经历千百年也不能够一展，它的风采，这当然是徒劳而无功用的。中州，中原地区。更，gēng音。售其伎，贡献其技艺，其技艺得到赏识。伎，通“技”。售，出售，这里是显露的意思。',
        '(14)“神者”二句：意思是，神奇性倘若不该这样，造物者就真的不存在了吧？神者，指神奇性，《易·系辞上》：“阴阳不测之谓神。”傥(tǎng)，通“倘”。倘若，或者。不宜，不合适。如是，如此，指“不为之中州，而列是夷狄”的现象。果，真的。',
        '(15)以慰夫贤而辱于此者：意思是，小石城山是用来慰藉那些贤明却被贬谪到这里的人们的。此句是指有人辩“无用”为“有用”的说法。',
        '(16)“其气”四句：意思是，那天地间的灵气，在这一带，不造就伟大的人物，却仅仅造就小石城山这样的景物，所以“楚之南”这地方缺少人才而多有石岩。此句是指有人辩“徒劳”为“功劳”的说法。其气之灵，这里指天地的灵气。楚，今湖南、湖北等地，春秋战国时属楚国。少人而多石，指少出贤人而多出奇石。',
    ],
    'vernacular' => [
