...
[
    'content' => [
        '太史公(1)曰：《诗》有之：“高山仰止，景行行止(2)。”虽不能至，然心乡(3)往之。余读孔氏书，想见其为人。适(4)鲁，观仲尼庙堂车服礼器，诸生以时习礼其家，余祗回(5)留之不能去云。天下君王至于贤人众矣，当时则荣，没则已焉。孔子布衣(6)，传十余世，学者宗之。自天子王侯，中国言《六艺》者折中于夫子(7)，可谓至圣矣!',
    ],
    'notes' => [
        '(1)太史公：司马迁的官名，用以自称。世家：《史记》中用以记载侯王家世的一种传记，“世家”之体古已有之。赞：文体名。《史记》一百三十篇，每篇最后都以“太史公曰”的形式，对所记的历史人物或事件加以评论，一般称为赞。',
        '(2)高山仰止，景行行止：出自《诗经·小雅·车舝(xiá)》。仰，这里是仰慕、敬仰的意思。景行，大道。这里喻指高尚的品德。行，这里是效法的意思。止，句末语气助词，无意义。',
        '(3)乡：通“向”。',
        '(4)适：往。',
        '(5)祗(zhī)回：相当于“低回”。流连，盘桓。祗，恭敬。有的版本作“低回”。',
        '(6)布衣：没有官职的人。',
