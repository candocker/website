...
[
    'content' => [
        '齐宣王见颜斶(1)，曰：“斶前(2)!”斶亦曰：“王前!”宣王不说。左右曰：“王，人君也。斶，人臣也。王曰‘斶前’，亦曰‘王前’，可乎?”斶对曰：“夫斶前为慕势，王前为趋士(3)。与使斶为慕势，不如使王为趋士。”王忿然作色曰：“王者贵乎?士贵乎?”对曰：“士贵耳，王者不贵。”王曰：“有说乎?”斶曰：“有。昔者秦攻齐，令曰：‘有敢去柳下季垄五十步而樵采者(4)，死不赦。’令曰：‘有能得齐王头者，封万户侯，赐金千镒。’由是观之，生王之头，曾不若死士之垄也。”宣王默然不悦。',
        '左右皆曰：“斶来，斶来!大王据千乘之地，而建千石锺，万石虡(5)。天下之士，仁义皆来役处(6);辩士并进，莫不来语;东西南北，莫敢不服。求万物无不备具，而百姓无不亲附(7)。今夫士之高者，乃称匹夫，徒步而处农亩，下则鄙野(8)、监门、闾里，士之贱也，亦甚矣!”',
        '斶对曰：“不然。斶闻古大禹之时，诸侯万国。何则?德厚之道，得贵士之力也。故舜起农亩，出于岳鄙，而为天子。及汤之时，诸侯三千。当今之世，南面称寡者，乃二十四。由此观之，非得失之策与?稍稍(9)诛灭，灭亡无族之时，欲为监门、闾里，安可得而有乎哉?是故《易传》不云乎。’居上位，未得其实，以喜其为名者(10)，必以骄奢为行。据慢骄奢(11)，则凶中之。是故无其实而喜其名者削，无德而望其福者约，无功而受其禄者辱，祸必握(12)。’故曰：‘矜功不立，虚愿不至。’此皆幸乐其名，华而无其实德者也。是以尧有九佐(13)，舜有七友，禹有五丞，汤有三辅，自古及今而能虚成名于天下者，无有。是以君王无羞亟(14)问，不愧下学;是故成其道德而扬功名于后世者，尧、舜、禹、汤、周文王是也。故曰：‘无形者，形之君也(15)。无端者，事之本也。’夫上见其原，下通其流，至圣人(16)明学，何不吉之有哉!老子曰：‘虽贵，必以贱为本;虽高，必以下为基。是以侯王称孤寡不谷(17)，是其贱必本于?’非(18)夫孤寡者，人之困贱下位也，而侯王以自谓，岂非下人而尊贵士与?夫尧传舜，舜传傅禹，周成王任周公旦，而世世称曰明主，是以明乎士之贵也。”',
        '宣王曰：“嗟乎!君子焉可侮哉，寡人自取病(19)耳!及今闻君子之言，乃今闻细人(20)之行，愿请受为弟子。且颜先生与寡人游，食必太牢(21)，出必乘车，妻子衣服丽都(22)。”　颜斶辞去曰：“夫玉生于山，制则破焉，非弗宝贵矣，然大璞不完。士生乎鄙野，推选则禄焉，非不得尊遂(23)也，然而形神不全。斶愿得归，晚食以当肉，安步以当车，无罪以当贵，清静贞正以自虞(24)。制言者王也，尽忠直言者斶也。言要道(25)已备矣，愿得赐归，安行而反臣之邑屋。”则再拜而辞去也。斶知足矣，归反朴(26)，则终身不辱也。',
        '君子曰：“斶知足矣，归真返璞，则终身不辱。”',
    ],
    'notes' => [
        '(1)颜斶(chù)：齐国隐士。',
        ...
        '(5)石(dàn)：古代的计量单位，一百二十斤为一石。钟：乐器。簴(jù)：古代悬挂乐器的架子中间的木柱。',
        '(6)役处：效力，供事。',
        '(7)无不：原作“不”，据黄丕烈《札记》补。百姓：原作“百”，据黄丕烈《札记》补。',
        '(8)鄙野：乡野。',
        '(9)稍稍：渐渐。',
        '(10)实：指居上位所应该具备的素质。以：而。为名：有（居上位的）名声。',
        '(11)据慢：倨慢，傲慢无礼。',
        '(12)约：受阻。握：通“渥”，厚重。',
        '(13)九佐：九位辅佐尧治理国家的官员。',
        '(14)亟：数，频繁。',
        '(15)无形者，形之君：无形可见的东西，是有形可见的东西的主宰。',
        '(16)至圣人：一本作“至圣”。',
        '(17)不谷：不善。用以自称，表谦恭之意。',
        '(18)非：一本无此字，于文义为顺。',
        '(19)自取病：即自取羞辱。',
        ...
        '(22)丽都：华丽。',
        '(23)尊遂：尊贵显达。',
        '(24)自虞：即自娱，自得其乐。虞：通“娱”，欢乐。',
        '(25)言要道：即言之要道，指进言所应该遵循的规则（亦即上文的“尽忠直言”）。',
        '(26)扑：此字误，应作“朴”或“璞”。反朴或反璞，均指舍弃富贵华丽而返归素朴真纯。',
    ],
    'vernacular' => [
