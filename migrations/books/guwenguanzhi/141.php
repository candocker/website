...
[
    'content' => [
        '维年月日，潮州刺史韩愈使军事衙推秦济(1)，以羊一、猪一，投恶溪之潭水，以与鳄鱼食(2)，而告之曰：',
        '昔先王既有天下，列山泽，罔绳擉刃(3)，以除虫蛇恶物为民害者，驱而出之四海之外。及后王德薄，不能远有，则江汉之间，尚皆弃之以与蛮、夷、楚、越(4);况潮岭海(5)之间，去京师万里哉!鳄鱼之涵淹卵育(6)于此，亦固其所。今天子嗣唐位，神圣慈武，四海之外，六合之内(7)，皆抚而有之;况禹迹所揜，扬州之近地(8)，刺史、县令之所治，出贡赋以供天地宗庙百神之祀之壤者哉?鳄鱼其不可与刺史杂处此土也。',
        '刺史受天子命，守此土，治此民，而鳄鱼睅然(9)不安溪潭，据处食民畜、熊、豕、鹿、獐，以肥其身，以种其子孙;与刺史亢拒，争为长雄(10);刺史虽驽弱，亦安肯为鳄鱼低首下心，伈伈睍睍(11)，为民吏羞，以偷活于此邪!且承天子命以来为吏，固其势不得不与鳄鱼辨。',
        '鳄鱼有知，其听刺史言：潮之州，大海在其南，鲸、鹏(12)之大，虾、蟹之细，无不归容，以生以食，鳄鱼朝发而夕至也。今与鳄鱼约：尽三日，其率丑类(13)南徙于海，以避天子之命吏;三日不能，至五日;五日不能，至七日;七日不能，是终不肯徙也。是不有刺史、听从其言也;不然，则是鳄鱼冥顽不灵(14)，刺史虽有言，不闻不知也。夫傲天子之命吏，不听其言，不徙以避之，与冥顽不灵而为民物害者，皆可杀。刺史则选材技吏民，操强弓毒矢，以与鳄鱼从事(15)，必尽杀乃止。其无悔!',
    ],
    'notes' => [
        '(1)维：句首语气词，一义为“在”。潮州：州名，治所唐时海阳县（今广东潮州市），辖境约相当于今广东省潮州、汕头、揭阳和梅州、汕尾市一部分地区。刺史：州的行政长官。军事衙推：州刺史的属官。衙推：府属掌管狱讼的官名。秦济：衙推的姓名。',
        '(2)恶溪：在潮安境内，又名鳄溪、意溪，韩江经此，合流而南。食：吃，食用。',
        '(3)列：同“烈”。罔：同“网”。擉(chuò)：刺。',
        '(4)蛮：古时对南方少数民族的贬称。夷：古时对东方少数民族的贬称。楚、越：泛指东南方偏远地区。',
        '(5)岭海：岭，即越城、都宠、萌渚、骑田、大庾等五岭，地处今湘、赣、桂、粤边境。海，南海。',
        '(6)涵淹：潜伏。卵育：生息。',
        '(7)今天子：指唐宪宗李纯。慈武：仁爱勇武。六合：天地四方。',
        '(8)禹迹：大禹，传说中古代部落联盟的领袖。曾奉舜之命治理洪水，足迹遍于九州。故称九州大地为“禹迹”、“禹域”。揜(yǎn)：同“掩”。扬州：传说大禹治水以后，把天下划为九州，扬州即其一，据《尚书·禹贡》：“淮，海惟扬州。”《尔雅·释地》：“江南曰扬州。”潮州古属扬州地域。',
        '(9)睅(hàn)然：瞪起眼睛，很凶狠的样子。睅，目大而突出。',
        '(10)亢拒：抗拒。古代抗、亢相通。长(zhǎng)：用作动词。',
        '(11)驽弱：平庸软弱。低首下心：形容屈服顺从。低首，低头不敢仰视。下心，屈服于人。伈(xǐn)伈：恐惧貌。睍(xiàn)睍：眯起眼睛看，喻胆怯。',
        '(12)鲸、鹏：鲸鱼与大鹏鸟。鹏：传说中的巨鸟，由鲲变化而成，也能在水中生活。见《庄子·逍遥游》。',
        '(13)丑类：指鳄鱼。',
        '(14)冥顽不灵：愚钝无知顽固不化。冥顽，愚昧无知。',
        '(15)材技吏民：有才能有技艺的官吏和百姓。从事：谓战斗。指对鳄鱼的惩罚。',
    ],
    'vernacular' => [
