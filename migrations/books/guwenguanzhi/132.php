...
[
    'content' => [
        '愈再拜(1)：愈之获见于阁下有年矣。始者亦尝辱一言之誉。贫贱也，衣食于奔走，不得朝夕继见。其后，阁下位益尊，伺候于门墙者日益进(2)。夫位益尊，则贱者日隔;伺候于门墙者日益进，则爱博而情不专。愈也道不加修，而文日益有名。夫道不加修，则贤者(3)不与;文日益有名，则同进者忌。始之以日隔之疏，加之以不专之望，以不与者之心，而听忌者之说。由是阁下之庭，无愈之迹矣。',
        '去年春，亦尝一进谒(4)于左右矣。温乎其容，若加其新也;属乎其言，若闵(5)其穷也。退而喜也，以告于人。其后，如东京取妻子(6)，又不得朝夕继见。及其还也，亦尝一进谒于左右矣。邈乎其容，若不察其愚也(7);悄乎其言，若不接其情也。退而惧也，不敢复进。',
        '今则释然悟，翻然悔曰：其邈也，乃所以怒其来之不继也;其悄也，乃所以示其意也。不敏之诛(8)，无所逃避。不敢遂进，辄自疏其所以(9)，并献近所为《复志赋》以下十首为一卷，卷有标轴(10)。《送孟郊序》一首，生纸写(11)，不加装饰。皆有揩字注字处，急于自解而谢，不能俟更写(12)。阁下取其意而略其礼可也。',
        '愈恐惧(13)再拜。',
    ],
    'notes' => [
        ...
        '(5)闵：同“悯”，怜恤，哀伤。',
        '(6)妻子：指妻子和儿子。',
        '(7)邈：远，此处形容脸上表情冷漠。若不察其愚：好像没有察见我的愚衷。',
        '(8)诛：责备。',
        '(9)遂：就，立刻。疏：分条陈述。',
        '(10)标轴：古代用纸或帛做成卷子，中心有轴，故一卷叫一轴。标轴是卷轴上所作的标记。',
        '(11)孟郊：字东野。唐代诗人，韩愈的朋友。生纸：未经煮捶或涂蜡的纸。唐代书写分熟纸与生纸，生纸用于丧事，或作草稿用。',
        '(12)揩：涂抹。注：添加。上述用生纸写信，不加装饰，有揩字注字处数语，乃是表示失礼和歉意。俟(sì)：等待。',
        '(13)恐惧：非常小心谨慎以至达到害怕不安的程度。',
    ],
    'vernacular' => [
        '韩愈再拜：',
