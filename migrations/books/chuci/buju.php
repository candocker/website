...
return [
    'chapters' => [
        [
            ...
            'vernacular' => [
                '屈原（被）流放了，三年不再能见（到国王）。（他）竭尽智慧用尽忠心，',
                '却被谗言遮挡和阻隔。（他）心情烦闷思想混乱，不知道何去何从。',
                '就前往拜见太卜郑詹尹说：',
                '“我有所疑惑，希望由先生您来决定。”',
                '詹尹就摆正蓍草拂净龟壳说：“您有什么赐教的啊？”',
                '译文二',
                '屈原被流放后，三年没能再见楚怀王。他竭尽智慧效忠国家，',
                '却被谗言谤语把他和君王遮蔽阻隔。他心烦意乱，不知如何是好。',
                '于是去见太卜郑詹尹问卜说：',
        ...
        [
            ...
            'vernacular' => [
                ...
                '还是跟从习俗和富贵者来偷生呢？',
                '是宁愿超然脱俗来保全（自己的）纯真呢，',
                '还是阿谀逢迎战战兢兢，咿咿喔喔（语无伦次地谄言献媚）来巴结妇人呢？',
                '是宁愿廉洁正直来使自己清白呢，',
                '译文二',
                '屈原说：“我宁可诚恳朴实、忠心耿耿呢，',
                '还是迎来送往、巧于逢迎而摆脱困境?',
        ...
        [
            ...
            'vernacular' => [
                '还是圆滑求全，像脂肪（一样滑）如熟皮（一样软），来谄媚阿谀呢？',
                '“是宁愿昂然（自傲）如同（一匹）千里马呢，',
                '还是如同（一只）普普通通的鸭子随波逐流，',
                '偷生来保全自己的身躯呢？',
                '“是宁愿和良马一起呢，还是跟随驽马的足迹呢？',
                '是宁愿与天鹅比翼齐飞呢，还是跟鸡鸭一起争食呢？',
                '“这些选择哪是吉哪是凶？应该何去何从？',
                '“（现实）世界浑浊不清：蝉翼被认为重，千钧被认为轻；',
                '黄钟被毁坏丢弃，瓦锅被认为可以发出雷鸣（般的声音）；谗言献媚的人位高名显，贤能的人士默默无闻。',
                '可叹啊沉默吧，谁知道我是廉洁忠贞的呢？”',
                '译文二',
                '还是圆滑诡诈、油滑适俗、趋炎附势?',
                '宁可像志行高远的千里驹呢，',
                ...
                '现在的世道混浊不清：认为蝉翼是重的，千钧是轻的；',
                '黄钟大吕竟遭毁弃，瓦釜陶罐却响如雷鸣；谗佞小人嚣张跋扈，贤明之士则默默无闻。',
                '唉，沉默吧，谁人能知我廉洁忠贞的心哪!”',
            ],
        ],
        [
            ...
            'spell' => [
                ...
                '"fū chǐ yǒu suǒ duǎn, cùn yǒu suǒ cháng,',
