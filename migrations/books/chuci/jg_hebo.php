    ...
    'chapters' => [
        [
            'content' => [
                ...
                '日将暮兮怅忘归，惟极浦兮寤怀；',
                '鱼鳞屋兮龙堂，紫贝阙兮珠宫；',
                '灵何惟兮水中；乘白鼋兮逐文鱼，与女游兮河之渚；',
                '流澌纷兮将来下；子交手兮东行，送美人兮南浦；',
                '波滔滔兮来迎，鱼鳞鳞兮媵予[5]。',
            ],
            'spell' => [
                ...
                'líng hé wéi xī shuǐ zhōng,chéng bái yuán xī zhú wén yú, yǔ nǚ yóu xī hé zhī zhǔ',
                'liú sī fēn xī jiāng lái xià, zi jiāo shǒu xī dōng xíng, sòng měi rén xī nán pǔ',
                'bō tāo tāo xī lái yíng, yú lín lín xī yìng yǔ.',
            ],
            'vernacular' => [
                '我和你河伯游在九河之上，大风吹起河面上掀动波浪。',
                '随你乘着荷叶作盖的水车，以双龙为驾螭龙套在两旁。',
                '登上河源昆仑向四处张望，心绪随着浩荡的黄河飞扬。',
                '但恨天色已晚而忘了归去，惟河水尽处令我寤寐怀想。',
                '鱼鳞盖屋顶堂上画着蛟龙，紫贝砌城阙朱红涂满室宫。',
                '河伯你为什么住在这水中？乘着大白鼋鲤鱼跟随身旁，随你河伯一起游弋在河上，',
                '浩浩河水缓缓地往东流淌。你握手道别将要远行东方，我送你送到这向阳的河旁。',
                ...
                '太阳下山人怅惘，只有极浦啊感悟怀；',
                '鱼鳞屋啊龙堂，紫贝嵌门柱，真珠饰房栊；',
                '水里作何游戏；乘白鼋文鱼，同你游泳到河边；',
                '水花乱飞溅下；与你携手向东行，送你同到河南岸；',
                '波浪滔滔来迎接，鱼鱼鳞来陪伴。',
            ...
            'notes' => [
                '①女(ru3汝)：通“汝”，你。九河：黄河的总名，前人说是黄河到兖州境即分九道，故称九河。',
                '②冲风：隧风，大风。横波：聚起波浪，扬波。',
