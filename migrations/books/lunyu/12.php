...
[
    'content' => [
        '颜渊问“仁”。子曰：“克己复礼(1)，为仁。一日克己复礼，天下归仁(2)焉。为仁由己，而由人乎哉？”颜渊曰：“请问其目(3)？”子曰：“非礼勿视，非礼勿听，非礼勿言，非礼勿动。”颜渊曰：“回虽不敏，请事(4)斯语矣！”',
    ],
    'notes' => [
...
[
    'content' => [
        '仲弓问“仁”。子曰：“出门如见大宾，使民如承大祭(1)；己所不欲，勿施於人；在邦无怨，在家无怨(2)。”仲弓曰：“雍虽不敏，请事(3)斯语矣！”',
    ],
    'notes' => [
...
[
    'content' => [
        '司马牛(1)问“仁”。子曰：“仁者，其言也訒(2)。”曰：“斯(3)言也訒，其谓之仁矣乎？”子曰：“为之难，言之得无訒乎？”',
    ],
    'notes' => [
...
[
    'content' => [
        '子张问“明”。子曰：“浸润之谮(1)，肤受之愬(2)，不行焉，可谓明也已矣。浸润之谮，肤受之愬，不行焉，可谓远(3)也已矣。”',
    ],
    'notes' => [
...
[
    'content' => [
        '哀公问於有若曰：“年饥，用不足，如之何？”有若对曰：“盍彻乎(1)！”曰：“二(2)，吾犹不足；如之何其彻也？”对曰：“百姓足，君孰不足？百姓不足，君孰与足？”',
    ],
    'notes' => [
...
[
    'content' => [
        '子张问“崇德(1)，辨惑(2)。”子曰：“主忠信，徒义(3)崇德也。爱之欲其生，恶之欲其死；既欲其生又欲其死，是惑也！”（诚不以富，亦只以异(4)。）',
    ],
    'notes' => [
        '(1)崇德：提高道德修养的水平。',
        '(2)惑：迷惑，不分是非。',
...
[
    ...
    'notes' => [
        '(1)齐景公：名杵(chǔ)臼(jiù)，齐国国君，公元前547年——公元前490年在位。',
    ],
    'vernacular' => [
...
[
    'content' => [
        '季康子问政於孔子曰：“如杀无道(1)，以就有道(2)，何如？”孔子对曰：“子为政，焉用杀？子欲善，而民善矣！君子之德风；小人之德草；草上之风(3)必偃(4)。”',
    ],
    'notes' => [
        '(1)无道：指无道的人。',
        '(2)有道：指有道的人。',
...
[
    'content' => [
        '子张问士：“何如斯可谓之达(1)矣？”子曰：“何哉？尔所谓达者！”子张对曰：“在邦必闻(2)，在家必闻。”子曰：“是闻也，非达也。夫达也者：质直而好义，察言而观色，虑以下人(3)；在邦必达，在家必达。夫闻也者：色取仁而行违，居之不疑；在邦必闻，在家必闻。”',
    ],
    'notes' => [
        '(1)达：通达，显达。',
        '(2)闻：有名望。',
...
[
    'content' => [
        '樊迟从游於舞雩之下。曰：“敢问崇德、修慝(1)、辨惑？”子曰：“善哉问！先事後得(2)，非崇德与？攻其恶，无攻人之恶，非修慝与？一朝之忿(3)，忘其身以及其亲，非惑与？”',
    ],
    'notes' => [
        '(1)修慝(tè)：慝，邪恶的念头。修，改正。这里是指改正邪恶的念头。',
...
[
    'content' => [
        '樊迟问“仁”。子曰：“爱人。”问“知”。子曰：“知人。”樊迟未达。子曰：“举直错诸枉(1)，能使枉者直。”樊迟退，见子夏曰：“乡(2)也，吾见於夫子而问‘知’；子曰：‘举直错诸枉，能使枉者直。’何谓也？”子夏曰：“富哉言乎！舜有天下，选於众，举皋陶(3)，不仁者远(4)矣；汤(5)有天下，选於众，举伊尹(6)，不仁者远矣。”',
    ],
    'notes' => [
        '(1)举直错诸枉：错，同“措”，放置。诸，这是“之于”二字的合音。枉，不正直，邪恶。意为选拔直者，罢黜枉者。',
        '(2)乡(xiàng)：同“向”，过去。',
        '(3)皋(gāo)陶(yáo)：传说中舜时掌握刑法的大臣。',
        '(4)远：动词，远离，远去。',
        '(5)汤：商朝的第一个君主，名履。',
        '(6)伊尹：汤的宰相，曾辅助汤灭夏兴商。',
    ],
