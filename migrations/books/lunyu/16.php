...
return [
    'chapters' => [
        [
            ...
            'notes' => [
                '(1)颛臾：音ｚｈｕāｎｙú，鲁国的附属国，在今山东省费县西。(2)有事：指有军事行动，用兵作战。(3)东蒙主：东蒙，蒙山。主，主持祭祀的人。(4)周任：人名，周代史官。(5)陈力就列：陈力，发挥能力，按才力担任适当的职务。(6)相：搀扶盲人的人叫相，这里是辅助的意思。(7)兕：音ｓì。雌性犀牛。(8)柙：音ｘｉá，用以关押野兽的木笼。(9)椟：音ｄú，匣子。(10)费：季氏的采邑。(11)贫、寡：可能有错误，应为寡、贫。(12)萧墙：照壁屏风。指宫廷之内。',
            ],
            'vernacular' => [
        ...
        [
            ...
            'notes' => [
                '(1)五世：指鲁国宣公、成公、襄公、昭公、定公五世。(2)逮：及。(3)四世：指季孙氏文子、武子、平子、桓子四世。(4)三桓：鲁国伸孙、叔孙、季孙都出于鲁桓公，所以叫三桓。',
            ],
            'vernacular' => [
        ...
        [
            ...
            'notes' => [
                '(1)节礼乐：孔子主张用礼乐来节制人。(2)骄乐：骄纵不知节制的乐。(3)佚：同“逸”。(4)晏乐：沉溺于宴饮取乐。',
            ],
            'vernacular' => [
        ...
        [
            ...
            'notes' => [
                '(1)陈亢：亢，音ｇāｎｇ，即陈子禽。(2)异闻：这里指不同于对其他学生所讲的内容。(3)远：音ｙｕàｎ，不亲近，不偏爱。',
            ],
            'vernacular' => [
