...
[
    ...
    'notes' => [
        '（1）尚同即上同，也即人们的意见应当统一于上级，并最终统一于天。这是墨子针对当时国家混乱而提出的政治纲领。墨子认为，天下混乱是由于没有符合天意的好的首领，因此主张选择“仁人”、“贤者”担任各级领导。这种思想与尚贤说在本质上基本一致，都是对当时贵族统治的批判。本篇分上、中、下三篇。',
        '（2）兹：通“滋”。',
        '（3）虖：通“乎”。',
        '（4）正长：即“政长”。',
        '（5）请：诚。',
...
'unscramble' => [
        ...
        '天下之百姓皆上同于天子，而不上同于天，则灾犹未去也。今若天飘风苦雨，溱溱而至者④，此天之所以罚百姓之不上同于天者也。是故子墨子言曰：古者圣王为五刑⑤，请以治其民。譬若丝缕之有纪⑥，罔罟之有纲⑦，所连收天下之百姓⑧不尚同其上者也。',
