...
'chapters' => [
    ...
    [
        ...
        'notes' => [
            ...
            '(4)以上两句出自《诗经·大雅·文王》',
            '(5)毕战：人名，滕国的一个臣子。滕国的臣子。井地：即井田，相传为古代奴隶社会的一种土地制度。以方九百亩的地为一个单位，划成九区，其中为公田，八家均私田百亩，同养公田。因形如井字，故名。参见下文所述。',
            '(6)圭(guī)：《易·益·六三》：“益之，用凶事，无咎。有孚，中行，告公用圭。”《孙子算经》卷上：“量之所起，起于粟，六粟为一圭，十圭为一撮。”本义为古代容量单位。圭田：这里用为供祭祀用的田土之意。',
        ],
        'vernacular' => [
