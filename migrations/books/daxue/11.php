...
[
    'content' => [
        '所谓平天下在治其国者，上老老(1)而民兴孝，上长长(2)而民兴悌，上恤孤而民不倍(3)，是以君子有絜矩之道(4)也。',
        '所恶于上，毋以使下，所恶于下，毋以事上；所恶于前，毋以先后；所恶于后，毋以从前；所恶于右，毋以交于左；所恶于左，毋以交于右；此之谓絜矩之道。',
        '《诗》云：“乐只君子，民之父母(5)。”民之所好(6)好之，民之所恶(7)恶之，此之谓民之父母。《诗》云：“节彼南山，维石岩岩(8)。赫赫师尹，民具尔瞻(9)。”有国者不可以不慎，辟，则为天下僇(10)矣。《诗》云：“殷之未丧师，克配上帝(11)。仪鉴于殷，峻命不易(12)。”道得众则得国(13)，失众则失国。',
        '是故君子先慎乎德。有德此(14)有人，有人此有土，有土此有财，有财此有用(15)。',
        '德者本也，财者末也。外本内末(16)，争民施夺(17)。是故财聚则民散，财散则民聚。是故言悖而出者(18)，亦悖而入；货(19)悖而入者，亦悖而出。',
        '《康诰》曰：“惟命不于常(20)。”道(21)善则得之，不善则失之矣。',
        '《楚书》曰(22)：“楚国无以为宝，惟善以为宝(23)。”舅犯(24)曰：“亡人无以为宝，仁亲以为宝(25)。”',
        '《秦誓》曰(26)：“若有一介臣，断断(27)兮无他技，其心休休(28)焉，其如有容(29)焉。人之有技，若己有之；人之彦圣(30)，其心好之，不啻(31)若自其口出。实(32)能容之，以能保我子孙黎民，尚亦有利哉！人之有技，媢嫉(33)以恶之；人之彦圣，而违之俾(34)不通：实不能容，以不能保我子孙黎民，亦曰殆(35)哉！”唯仁人放流(36)之，迸诸四夷(37)，不与同中国(38)。此谓唯仁人为能爱人，能恶人。见贤而不能举(39)，举而不能先(40)，命也(41)；见不善而不能退(42)，退而不能远，过也(43)。好人之所恶(44)，恶人之所好，是谓拂(45)人之性，灾必逮夫身(46)。是故君子有大道(47)，必忠信以得之，骄泰(48)以失之。',
        '生财有大道，生之者众，食之者寡，为之者疾，用之者舒(49)，则财恒足矣。仁者以财发身(50)，不仁者以身发财。未有上好仁而下不好义者也，未有好义其事不终(51)者也，未有府库(52)财非其财者也。孟献子(53)曰：“畜马乘不察于鸡豚(54)，伐冰之家(55)不畜牛羊，百乘之家(56)不畜聚敛之臣(57)。与其有聚敛之臣，宁有盗臣(58)。”此谓国不以利为利，以义为利也。长国家而务财用(59)者，必自小人矣。彼(60)为善之，小人之使为(61)国家，灾害并至。虽有善者，亦无如之何(62)矣！此谓国不以利为利，以义为利也。',
    ],
    'notes' => [
        '(1)老老：尊敬老人之意。第一个“老”是动词，指的是把老人当做老人看待的意思。',
        '(2)长长：敬重长辈之意。前一个“长”字作动词，意思是把长辈当作长辈看待。',
        '(3)恤：体恤怜爱之意。孤：指的是幼年丧父的孤儿。倍：通“背”，背离、背叛之意。',
        '(4)絜矩之道：是儒家的伦理思想，指一言一行要有模范作用。絜(xié)：度量之意。矩：画矩形所用的尺子，是规则、法度之意。',
        '(5)《诗》云：此指《诗经·小雅·南山有台》。乐：欢快、喜悦之意。只：助词，无意义。',
        '(6)好(hào)：喜好。',
        '(7)恶(wù)：厌恶。',
        '(8)《诗》云：此指《诗经·小雅·节南山》。节：通“截”，高耸的样子。维：语气词，无意义。岩岩：险峻之意。',
        '(9)赫赫：显赫，显著的样子。师尹：指的是太师尹氏，太师是周代的三公之一。具：通“俱”。尔：你。瞻：瞻仰、仰视之意。',
        '(10)僇(lù)：杀戮之意。',
        '(11)《诗》：此指《诗经·大雅·文王》。丧师：丧失民心。克：能够。配：与……相符。',
        '(12)仪：宜，应该。监：警戒，鉴戒。峻：大。不易：不易保有。',
        '(13)道：说。',
        '(14)此：乃，才。',
        '(15)用：用度。',
        '(16)外本内末：指本末倒置。外：疏远，轻视。内：亲近，重视。',
        '(17)争民：民众互相争斗之意，一说“与民争利”。施夺：抢夺财富。',
        '(18)悖(bèi)：逆、反。',
        '(19)货：财富。',
        '(20)常：恒常留驻一方。',
        '(21)道：说。',
        '(22)《楚书》是楚昭王时编写的史书。',
        '(23)楚国无为宝，惟善以为宝：出自《楚书》。王孙圉受楚昭王之命出使晋国。晋国赵简子问楚国珍宝美玉之事。王孙圉回应说楚国从来不把美玉当珍宝，而只是将那些和观射父一样的大臣看做珍宝。事见《国语·楚语》。汉代刘向的《新序》中也有类似的记载。',
        '(24)舅犯：是晋文公重耳的舅舅，名狐偃，字子犯。',
        '(25)亡人无以为宝，仁亲以为宝：亡人：逃亡之人，特指重耳。子犯对重耳说这些话的历史情形是，晋僖公四年，晋献公因听信谗言，逼迫太子申生自缢而死。重耳避难逃亡在狄国时，晋献公逝世。秦穆公派人劝重耳回国执政。子犯得知此事，认为不能回去，随即对重耳说了这样的话。事见《礼记·檀弓下》。',
        '(26)《秦誓》：《尚书·周书》中的一篇。',
        '(27)断断：真诚，心地诚实之意。',
        '(28)休休：宽宏大量，胸怀宽广之意。',
        '(29)有容：指能够包容人。',
        '(30)彦圣：德才兼备之意。彦：美好。圣：开明。',
        '(31)不啻(chì)：不只是。',
        '(32)实：是。',
        '(33)媢(mào)疾：嫉妒之意。',
        '(34)违：阻碍之意。俾(bǐ)：使得。',
        '(35)殆：危险。',
        '(36)放流：流放。',
        '(37)迸：即“屏”，驱逐之意。四夷：东南西北各方之夷。夷是古代东方的部族。',
        '(38)中国：指的是国家的中心地区。与现代意义的“中国”一同意义不一样。',
        '(39)举：举荐。',
        '(40)先：优先。',
        '(41)命：是“慢”之误字。轻慢之意。',
        '(42)退：黜退。',
        '(43)过：过错。',
        '(44)好(hào)人之所恶(wù)：喜好众人所厌恶的。',
        '(45)拂：逆，违背。',
        '(46)菑(zāi)：同灾。逮：等到之意。夫：助词，无意义。',
        '(47)大道：常理正道。',
        '(48)骄泰：骄横放纵，放肆骄奢。',
        '(49)生：生产。食：享用。疾：迅速。舒：舒缓，缓慢。',
        '(50)发身：修炼身心。发：发起之意。',
        '(51)不终：不成功。',
        '(52)府库：存放国家贵重器物的地方。',
        '(53)孟献子：鲁国的大夫，姓仲孙，名蔑。',
        '(54)畜：养。乘(shèng)：是四匹马拉的车，古代大夫级的待遇。察，关注。',
        '(55)伐冰之家：办丧事时能够用冰来保存尸体的人家。卿大夫以上的大官能享受的待遇。',
        '(56)百乘之家：家中有一百辆车，是古代的大家族，通常是有封地的诸侯王。',
        '(57)聚敛之臣：聚敛民财的家臣。聚：聚集。敛：征收。',
        '(58)盗臣：指盗窃公家财物的家臣。',
        '(59)长(zhǎng)国家：成为一国之长，指的是帝王。务：致力于。',
        '(60)彼：这里指国君。',
        '(61)为：治理。',
        '(62)无如之何：拿它没有办法。',
    ],
    'vernacular' => [
        ...
        '《诗经》说：“使人心悦诚服的国君啊，是老百姓的父母。”百姓喜欢的他也喜欢，老百姓厌恶的他也厌恶，这样的国君就可以说是老百姓的父母了。《诗经》说：“巍峨的南山啊，岩石耸立。显赫的尹太师啊，百姓都仰望你。”统治国家的人不可不谨慎。稍有偏颇，就会被天下人推翻。《诗经》说：“殷朝没有丧失民心的时候，还是能够与上天的要求相符的。请用殷朝作个鉴戒吧，守住天命并不是一件容易的事。”这就是说，得到民心就能得到国家，失去民心就会失去国家。',
