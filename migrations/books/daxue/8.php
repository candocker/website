...
[
    'content' => [
        '所谓修身(1)在正其心者，身有所忿懥(2)，则不得其正，有所恐惧，则不得其正，有所好乐(3)，则不得其正，有所忧患，则不得其正。心不在焉，视而不见，听而不闻，食而不知其味。此谓修身在正其心。',
    ],
    'notes' => [
        '(1)修身：指的是修养良好的品德。身：程颐认为应为“心”。',
        '(1)忿懥(zhì)：愤怒之意。',
        '(1)好乐：喜好，偏好。',
    ],
    'vernacular' => [
    ...
    'unscramble' => [
        ...
        '也就是说，修身在正其心不外乎是要心思端正，不要三心二意，不要为情所牵，“心不在焉，视而不见，听而不闻，食而不知其味”。(这几句后来成了成语和名言，用来生动地描绘那种心神不定，思想不集中的状态，是教书先生在课堂上批评学生的常用语言。)',
