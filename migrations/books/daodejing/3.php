...
[
    'name' => '白话',
    'content' => [
        '不上贤(1)，使民不争；不贵难得之货(2)，使民不为盗(3)；不见可欲(4)，使民不乱。是以圣人之治也，虚其心(5)，实其腹，弱其志(6)，强其骨，恒使民无知、无欲也。使夫知不敢(7)、弗为而已(8)，则无不治矣(9)。',
    ],
    'vernacular' => [
    ...
    'notes' => [
        ...
        '(2)贵：重视，珍贵。货：财物。',
        '(3)盗：窃取财物。',
        '(4)见：通“现”，出现，显露。此是显示，炫耀的意思。',
        '(5)虚其心：虚，空虚。心：古人以为心主思维，此指思想，头脑。虚其心，使他们心里空虚，无思无欲。',
        '(6)弱其志：使他们减弱志气。削弱他们竞争的意图。',
        '(7)敢：进取。',
        '(8)弗为：同“无为”。',
        '(9)治：治理，此意是治理得天下太平。',
    ],
