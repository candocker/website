...
[
    'name' => '白话',
    'content' => [
        '上德不德(1)，是以有德；下德不失德(2)，是以无德(3)。上德无为而无以为(4)；下德无为而有以为(5)。上仁为之而无以为；上义为之而有以为。上礼为之而莫之应，则攘臂而扔之(6)。故失道而后德，失德面后仁，失仁而后义，失义而后礼。夫礼者，忠信之薄(7)，而乱之首(8)。前识者(9)，道之华(10)，而愚之始。是以大丈夫处其厚(11)，不居其薄(12)；处其实，不居其华。故去彼取此。',
    ],
    'vernacular' => [
