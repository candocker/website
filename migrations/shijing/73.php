...
return [
    ...
    'nameShort' => '大车',
    'nameSpell' => ' dà jū',
    'brief' => '刺周大夫也。礼义陵迟，男女淫奔，故陈古以刺今大夫不能听男女之讼焉。(3章4句)',
    'keyword' => '关键词：诗经,爱情,故事,国风,王风',
    'chapters' => [
        [
            'spell' => [
                'dà jū kǎn kǎn ，cuìyīrútǎn；',
                'qǐ bù ěrsī？wèi zi bù gǎn。',
                'dà jū tūntūn，cuìyīrúmén；',
                'qǐ bù ěrsī？wèi zǐ bù bēn 。',
                'gǔzéyìshì，sǐzé tóng xué；',
                'wèi yú bú xìn ， yǒu rújiǎorì！',
            ],
            'content' => [
                '大车槛槛，毳衣如菼；',
                '岂不尔思？畏子不敢。',
