...
return [
    ...
    'chapters' => [
        [
            'spell' => [
                'jiǎnxījiǎnxī！fāng jiāng wàn wǔ；',
                'rìzhīfāng zhōng ，zàiqián shàng chù 。',
                'shuòrényǔyǔ，gōngtíng wàn wǔ。',
                'yǒu lìrúhǔ，zhípèirúzǔ。',
                'zuǒshǒuzhíyuè，yòushǒubǐng dí 。',
                'hèrúwòzhě，gōngyáncìjué。',
                'shān yǒu zhēn，xí yǒu líng。yún shuí zhīsī？',
                'xīfāngměirén。bǐměirénxī，xīfāngzhīrénxī！',
            ],
            'content' => [
                '简兮简兮！方将万舞；',
                '日之方中，在前上处。',
