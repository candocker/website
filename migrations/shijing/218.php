...
return [
    ...
    'nameShort' => '车舝',
    'nameSpell' => ' jū xiá',
    'brief' => '大夫刺幽王也。襃姒嫉妬，无道并进，谗巧败国，德泽不加于民。周人思得贤女以配君子，故作是诗也。(5章6句)',
    'keyword' => '关键词：诗经,怀古,婚姻,小雅,甫田之什',
    'chapters' => [
        [
            'spell' => [
                'jiān guān jū zhīxiáxī！sīluánjì nǚ shìxī！',
                'fěijīfěikě，déyīnlái kuò 。',
                'suī wú hǎo yǒu，shì yàn qiě xǐ。',
                'yīnbǐpínglín， yǒu jíwéijiāo。',
                'chénbǐshuò nǚ ， lìng délái jiào 。',
                'shì yàn qiě yù， hǎo ěr wú yì。',
                'suī wú zhǐjiǔ，shì yǐn shù jī 。',
                'suī wú jiāyáo，shì shí shù jī 。',
                'suī wú dé yǔ rǔ ，shìgē qiě wǔ。',
                'zhìbǐgāogāng，xī qí zhà xīn。',
                'xī qí zhà xīn， qí yè xǔ xī！',
                'xiān wǒgòuěr，wǒxīn xiè xī！',
                'gāoshān yǎng zhǐ， jǐng xíng xíng zhǐ！',
                'sìmǔfēifēi， liù pèirúqín。',
                'gòuěrxīnhūn，yǐwèiwǒxīn。',
            ],
            'content' => [
                '间关车之舝兮！思娈季女逝兮！',
                '匪饥匪渴，德音来括。',
