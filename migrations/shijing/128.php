...
return [
    ...
    'nameShort' => '小戎',
    'nameSpell' => ' xiǎo róng',
    'brief' => '美襄公也。备其兵甲，以讨西戎。西戎方强，而征伐不休，国人则矜其车甲，妇人能闵其君子焉。(3章10句)',
    'keyword' => '关键词：诗经,战争,思念,国风,秦风',
    'chapters' => [
        [
            'spell' => [
                'xiǎoróngjiànshōu，wǔmùliángzhōu；',
                'yóuhuánxiéqū，yīnyǐnwùxù。',
                'wényīnchànggǔ，jiàwǒqízhù。',
                'yánniànjūn zǐ ，wēn qí rúyù；',
                'zài qí bǎnwū，luànwǒxīn qǔ ！',
                'sìmǔkǒngfù， liù pèizàishǒu；',
                'qíliúshì zhōng ，guālíshìcān。',
                'lóngdùnzhī hé ，wùyǐjuénà。',
                'yánniànjūn zǐ ，wēn qí zàiyì；',
                'fānghé wéi qī ？húránwǒniànzhī！',
                'jiànsìkǒngqún， qiú máowù duì ；',
                'méng fá yǒu yuàn，hǔchànglòuyīng。',
                'jiāochàngèrgōng，zhúbìgǔnténg。',
                'yánniànjūn zǐ ， zài qǐn zài xīng ；',
                'yānyānliángrén，zhìzhìdéyīn！',
            ],
            'content' => [
                '小戎俴收，五楘梁辀；',
                '游环胁驱，阴靷鋈续。',
