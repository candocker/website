...
return [
    'name' => '国风·周南·关雎',
    'nameSpell' => 'guó fēng · zhōu nán ·guān jū',
    'spell' => '',
    ...
    'chapters' => [
        [
            ...
            'vernacular' => [
                ...
                '译文二',
                '雎鸟不停地在水中的绿洲上和鸣歌唱。文静美好的少女,是少年心中的好配偶。',
                '长长短短的荇莱,在船的左右两边求取。文静美好的少女,是少年日夜美好的追求。',
                '文静美好的少女难以追求,朝思暮想,魂牵梦绕。思悠悠,思悠悠,唉!翻来覆去难成眠。',
                '长长短短的荇莱,左边右边来采摘。对那文静美好的少女,鼓瑟弹琴迎她过来。',
                '长长短短的荇菜,左边右边来挑选。文静美好的少女,敲钟击鼓让她笑逐颜开。',
            ],
            'unscramble' => [
                '关雎赏析',
