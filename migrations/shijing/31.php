...
return [
    ...
    'nameShort' => '击鼓',
    'nameSpell' => ' jī gǔ',
    'brief' => '怨州吁也。卫州吁用兵暴乱，使公孙文仲将而平陈与宋，国人怨其勇而无礼也。(5章4句)',
    'keyword' => '关键词：诗经,抒情,战争,国风,邶风',
    'chapters' => [
        [
            'spell' => [
                'jīgǔ qí tāng ，yǒngyuèyòngbīng；',
                '',
                '土国城漕，我独南行。',
                '从孙子仲，平陈与宋；',
                '不我以归，忧心有忡。',
            ...
            'content' => [
                '击鼓其镗，踊跃用兵；',
                'tǔguóchéngcáo，wǒdú nán xíng 。',
                'cóng sūn zǐ zhòng，píngchén yǔ sòng；',
                'bù wǒyǐguī，yōuxīn yǒu chōng。',
                'yuánjūyuán chǔ ？yuán sàng qí mǎ？',
                'yúyǐqiúzhī？yúlínzhīxià。',
                'sǐshēng qì kuò， yǔ zǐ chéng yuè 。',
                'zhí zǐ zhīshǒu， yǔ zǐ xiélǎo。',
                'xūjiēkuòxī！ bù wǒhuóxī！',
                'xūjiēxúnxī！ bù wǒ xìn xī！',
            ],
            'vernacular' => [
