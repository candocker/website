...
return [
    ...
    'nameShort' => '陟岵',
    'nameSpell' => ' zhì hù',
    'brief' => '刺时也。大夫忧其君小学而迫，而俭以啬，不能用其民，而无德教，日以侵削，故作是诗也。(3章6句)',
    'keyword' => '关键词：诗经,思念,国风,魏风',
    'chapters' => [
        [
            'spell' => [
                'zhìbǐhùxī，zhānwàng fù xī！',
                'fù yuē：jiē， yǔ zǐ xíng yì，sùyè wú yǐ。',
                'shàng shènzhānzāi！yóulái wú zhǐ。',
                'zhìbǐqǐxī，zhānwàngmǔxī！',
                'mǔyuē：jiē， yǔ jì xíng yì，sùyè wú mèi。',
                'shàng shènzhānzāi！yóulái wú qì。',
                'zhìbǐgāngxī，zhānwàngxiōngxī！',
                'xiōngyuē：jiē， yǔ dì xíng yì，sùyèbìxié。',
                'shàng shènzhānzāi！yóulái wú sǐ。',
            ],
            'content' => [
                '陟彼岵兮，瞻望父兮！',
                '父曰：嗟，予子行役，夙夜无已。',
