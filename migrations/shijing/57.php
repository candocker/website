...
return [
    ...
    'chapters' => [
        [
            'spell' => [
                'shuòrén qí qí，yìjǐnjiǒngyī；',
                'qí hóu zhī zǐ ，wèi hóu zhī qī ；',
                'dōnggōngzhīmèi，xíng hóu zhīyí，tángōngwéisī。',
                'shǒurúróu tí ，fūrúníngzhī；',
                'lǐngrú qiú qí，chǐrúhùxī；',
                'qínshǒu é méi，qiǎoxiàoqiànxī，měimùpànxī！',
                'shuòrénáoáo， shuì yúnóngjiāo；',
                'sìmǔ yǒu jiāo，zhūfénbiāobiāo。 dí fúyǐ cháo 。',
                'dà fū sùtuì， wú shǐjūnláo。',
                'héshuǐyángyáng， běi liúguōguō；',
                'shīgū huò huò ，zhānwěibōbō 。jiātǎnjiējiē。',
                'shùjiāngnièniè，shùshì yǒu qiè。',
            ],
            'content' => [
                '硕人其颀，衣锦褧衣；',
                '齐侯之子，卫侯之妻；',
