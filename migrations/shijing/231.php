...
return [
    ...
    'nameShort' => '瓠叶',
    'nameSpell' => ' hù yè',
    'brief' => '大夫刺幽王也。上弃礼而不能行，虽有牲牢[雝下食]饩，不肯用也。故思古之人，不以微薄废礼焉。(4章4句)',
    'keyword' => '关键词：诗经,咏物,宴饮,小雅,鱼藻之什',
    'chapters' => [
        [
            'spell' => [
                'fānfānhù yè ， cǎi zhī pēng zhī。',
                'jūn zǐ yǒu jiǔ，zhuóyánchángzhī。',
                'yǒu tùsīshǒu， páo zhīfánzhī。',
                'jūn zǐ yǒu jiǔ，zhuóyánxiànzhī。',
                'yǒu tùsīshǒu，fánzhīzhìzhī。',
                'yǒu jiǔ，zhuóyánzuòzhī。',
                'yǒu tùsīshǒu，fánzhī páo zhī。',
                'jūn zǐ yǒu jiǔ，zhuóyánchóuzhī。',
            ],
            'content' => [
                '幡幡瓠叶，采之亨之。',
                '君子有酒，酌言尝之。',
