...
return [
    'chapters' => [
        [
            'spell' => [
                'yúyǐ cǎi pín ? nán jiànzhībīn。',
                'yúyǐ cǎi zǎo?yúbǐ xíng lǎo 。',
                'yúyǐ chéng zhī?wéikuāngjíjǔ。',
                'yúyǐxiāngzhī?wéiqíjífǔ。',
                'yúyǐdiànzhī?zōngshìyǒuxià。',
                'shuí qí shīzhī? yǒu zhāi jì nǚ 。',
            ],
            'content' => [
                '于以采蘋?南涧之滨。',
                '于以采藻?于彼行潦。',
