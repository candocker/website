...
return [
    ...
    'chapters' => [
        [
            'spell' => [
                'xíxí gǔ fēng ，yǐyīnyǐ yǔ 。',
                'mǐn miǎn tóng xīn， bù yí yǒu nù。',
                'cǎi fēng cǎi fēi ， wú yǐxià tǐ ；',
                'déyīn mò wéi，jíěr tóng sǐ。',
                'xíng dàochíchí， zhōng xīn yǒu wéi；',
                'bù yuǎnyīěr， bó sòngwǒjī。',
                'shuí wèitúkǔ， qí gānrú jì ；',
                'yàněrxīnhūn，rúxiōngrú dì 。',
                'jīngyǐwèizhuó，shíshí qí zhǐ；',
                'yàněrxīnhūn， bù wǒxièyǐ。',
                'wúshìwǒliáng，wú fā wǒgǒu；',
                'wǒgōng búyuè，huángxùwǒhòu。',
                'jiù qí shēnyǐ，fāngzhīzhōuzhī；',
                'jiù qí qiǎn yǐ，yǒngzhīyóuzhī。',
                'hé yǒu hé wú ， mǐn miǎnqiúzhī；',
                'fánmín yǒu sāng ，púfújiùzhī。',
                'bù wǒnéng xù ，fǎnyǐwǒ wéi chóu；',
                'jìzǔwǒdé， gǔ yòng bú shòu。',
                'xīyùkǒngyùjū，jíěrdiānfù；',
                'jìshēngjìyù，bǐ yú yúdú。',
                'wǒ yǒu zhǐxù，yìyǐyùdōng；',
                'yàněrxīnhūn，yǐwǒyùqióng。',
                'yǒu guāng yǒu kuì ，jìyíwǒyì；',
                'bú niànxīzhě，yīyúláixì。',
            ],
            'content' => [
                '习习谷风，以阴以雨。',
                '黾勉同心，不宜有怒。',
