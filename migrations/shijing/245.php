...
return [
    ...
    'chapters' => [
        [
            'spell' => [
                'juéchūshēngmín，shíwéijiāngyuán。shēngmínrúhé？',
                'kèyīnkèsì，yǐfú wú zǐ ；',
                'lǚdìwǔmǐnxīn，yōujièyōuzhǐ。',
                'zài zhèn zài sù。 zài shēng zài yù，shíwéihòujì。',
                'dàn mí juéyuè，xiān shēng rúdá；',
                'bù chèbú pì， wú zāi wú hài。',
                'yǐhèjuélíng。 shàng dì pīníng ？',
                'bù kāngyīnsì，jūránshēng zǐ ！',
                'dànzhìzhīài xiàng ，niú yáng féizìzhī；',
                'dànzhìzhīpínglín， huì fápínglín；',
                'dànzhìzhīhánbīng，niǎofùyìzhī。',
                'niǎonǎiqùyǐ，hòujì gū yǐ。',
                'shí qín shíxū，juéshēng zài lù。',
                'dànshípúfú，kèqíkè nì ，yǐjiùkǒu shí 。',
                'yìzhīrěnshū，rěnshūpèipèi，héyìsuìsuì，',
                'mámàiměngměng ，guādiéběngběng 。',
                'dànhòujìzhīsè， yǒu xiàng zhīdào。',
                'fújuéfēngcǎo， zhòng zhīhuángmào。',
                'shífāngshíbāo，shí zhǒng shí yòu 。shí fā shíxiù，',
                'shíjiānshí hǎo ，shíyǐngshílì；jí yǒu tái jiā shì。',
                'dàn jiàng jiā zhǒng ，wéijùwéipī，wéiménwéiqǐ。',
                'gèng zhījùpī，shìhuòshìmǔ；',
                'héngzhīménqǐ，shì rèn shìfù，yǐguīzhàosì。',
                'dànwǒsìrúhé？',
                'huòchōnghuò yóu，huò bǒ huòróu。',
                'shìzhīsǒusǒu，zhēngzhīfúfú；',
                'zài móu zài wéi。qǔxiāojìzhī。',
                'qǔdīyǐbá， zài fán zài liè，yǐ xīng sìsuì。',
                'áng chéng yúdòu，yúdòuyúdēng， qí xiāngshǐshēng；',
                'shàng dìjūxīn。hú xiù dǎn shí？',
                'hòujìzhàosì。shù wú zuìhuǐ，yǐqìyújīn。',
            ],
            'content' => [
                '厥初生民，时维姜嫄。生民如何？',
                '克禋克祀，以弗无子；',
            ...
            'notes' => [
                ...
                '(26)旆(pèi)旆：草术茂盛。',
                '(27)役：通“颖”。颖，禾苗之末。穟(suì)穟：禾穗丰硬下垂的样子[2]',
                '(28)幪(měng)幪：茂密的样子。',
                ...
                '(40)降：赐与。',
                '(41)秬(jù)：黑黍。秠(pī)：黍的一种，一个黍壳中含有两粒黍米。[3]',
                ...
                '(57)登：瓦制容器。',
                '(58)居歆(xīn)：为歆，应该前来享受。',
                '(59)胡臭(xiù)亶(dǎn)时：为什么香气诚然如此好。臭，香气;亶，诚然，确实;时，善，好。',
            ],
        ],
    ],
];