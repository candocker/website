...
'xiaoya' => [
    ...
    'elems' => [[
        ...
        'poems' => [
            ...
            ['code' => '165', 'name' => '伐木'], ['code' => '166', 'name' => '天保'], ['code' => '167', 'name' => '采薇'], ['code' => '168', 'name' => '出车'],
            ['code' => '169', 'name' => '杕杜'], ['code' => '170', 'name' => '鱼丽'],
        ],
    ],
    [
        ...
        'poems' => [
            ...
            ['code' => '175', 'name' => '彤弓'], ['code' => '176', 'name' => '菁菁者莪'], ['code' => '177', 'name' => '六月'], ['code' => '178', 'name' => '采芑'],
            ['code' => '179', 'name' => '车攻'], ['code' => '180', 'name' => '吉日'],
        ],
    ],
    [
        'code' => 'hongyanzhishi',
        ...
        'poems' => [
            ...
            ['code' => '185', 'name' => '祈父'], ['code' => '186', 'name' => '白驹'], ['code' => '187', 'name' => '黄鸟'], ['code' => '188', 'name' => '我行其野'],
            ['code' => '189', 'name' => '斯干'], ['code' => '190', 'name' => '无羊'],
        ],
    ],
    [
        ...
        'poems' => [
            ...
            ['code' => '195', 'name' => '小旻'], ['code' => '196', 'name' => '小宛'], ['code' => '197', 'name' => '小弁'], ['code' => '198', 'name' => '巧言'],
            ['code' => '199', 'name' => '何人斯'], ['code' => '200', 'name' => '巷伯'],
        ],
    ],
    [
        'code' => 'gufengzhishi',
        ...
        'poems' => [
            ...
            ['code' => '205', 'name' => '北山'], ['code' => '206', 'name' => '无将大车'], ['code' => '207', 'name' => '小明'], ['code' => '208', 'name' => '鼓钟'],
            ['code' => '209', 'name' => '楚茨'], ['code' => '210', 'name' => '信南山'],
        ],
    ],
    [
        'code' => 'putianzhishi',
        ...
        'poems' => [
            ...
            ['code' => '215', 'name' => '桑扈'], ['code' => '216', 'name' => '鸳鸯'], ['code' => '217', 'name' => '頍弁'], ['code' => '218', 'name' => '车临'],
            ['code' => '219', 'name' => '青蝇'], ['code' => '220', 'name' => '宾之初筵'],
        ],
    ],
    [
        'code' => 'yuzaozhishi',
        ...
        'poems' => [
            ...
            ['code' => '225', 'name' => '都人士'], ['code' => '226', 'name' => '采绿'], ['code' => '227', 'name' => '黍苗'], ['code' => '228', 'name' => '隰桑'],
            ['code' => '229', 'name' => '白华'], ['code' => '230', 'name' => '绵蛮'],
        ],
    ],
    [
        'code' => 'huyezhishi',
...
'daya' => [
    ...
    'elems' => [[
        ...
        'poems' => [
            ...
            ['code' => '239', 'name' => '旱麓'], ['code' => '240', 'name' => '思齐'], ['code' => '241', 'name' => '皇矣'], ['code' => '242', 'name' => '灵台'],
            ['code' => '243', 'name' => '下武'], ['code' => '244', 'name' => '文王有声'],
        ],
    ],
    [
        'code' => 'shengminzhishi',
        ...
        'poems' => [
            ...
            ['code' => '249', 'name' => '假乐'], ['code' => '250', 'name' => '公刘'], ['code' => '251', 'name' => '泂酌'], ['code' => '252', 'name' => '卷阿'],
            ['code' => '253', 'name' => '民勞'], ['code' => '254', 'name' => '板'],
        ],
    ],
    [
        'code' => 'dangzhishi',
        ...
        'poems' => [
            ...
            ['code' => '259', 'name' => '崧高'], ['code' => '260', 'name' => '烝民'], ['code' => '261', 'name' => '韓奕'], ['code' => '262', 'name' => '江汉'],
            ['code' => '263', 'name' => '常武'], ['code' => '264', 'name' => '瞻卬'], ['code' => '265', 'name' => '召旻'],
        ],
    ],
],
],
'song' => [
    ...
    'elems' => [[
        ...
        'poems' => [
            ...
            ['code' => '270', 'name' => '天作'], ['code' => '271', 'name' => '昊天有成命'], ['code' => '272', 'name' => '我將'], ['code' => '273', 'name' => '时迈'],
            ['code' => '274', 'name' => '執競'], ['code' => '275', 'name' => '思文'], ['code' => '276', 'name' => '臣工'], ['code' => '277', 'name' => '噫嘻'],
            ['code' => '278', 'name' => '振鷺'], ['code' => '279', 'name' => '丰年'], ['code' => '280', 'name' => '有瞽'], ['code' => '281', 'name' => '潛'],
            ['code' => '282', 'name' => '雍'], ['code' => '283', 'name' => '载见'], ['code' => '284', 'name' => '有客'], ['code' => '285', 'name' => '武'],
            ['code' => '286', 'name' => '闵予小子'], ['code' => '287', 'name' => '访落'], ['code' => '288', 'name' => '敬之'], ['code' => '289', 'name' => '小毖'],
            ['code' => '290', 'name' => '载芟'], ['code' => '291', 'name' => '良耜'], ['code' => '292', 'name' => '丝衣'], ['code' => '293', 'name' => '酌'],
            ['code' => '294', 'name' => '桓'], ['code' => '295', 'name' => '賚'], ['code' => '296', 'name' => '般'],
        ],
    ],
    [
        'code' => 'lusong',
