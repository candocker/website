    ...
    'chapters' => [
        [
            ...
            'content' => [
                ...
                『３』「宽柔以教，不报无道，南方之强也。君子居之。」
                『４』衽金革，死而不厌，北方之强也。而强者居之。」
                『５』故君子和而不流，强哉矫。中立而不倚，强哉矫。国有道，不变塞焉，强哉矫。国无道，至死不变，强哉矫。」',
            ],
            'notes' => [
                '子路：名仲由，孔子的学生。（2）抑：选择性连词，意为“还是”。而：代词，你。与：疑问语气词。（3）报：报复。（4）居：处。（5）衽：卧席，此处用为动词。金：指铁制的兵器。革：指皮革制成的甲盾。（6）死而不厌：死而后已的意思。（7）和而不流：性情平和又不随波逐流。（8）矫：坚强的样子。 （9）不变塞：不改变志向。',
            ],
            'vernacular' => [
