    ...
    'chapters' => [
        [
            'content' => [
                ...
                '博厚，配地。高明，配天。悠久，无疆(3)。',
                '如此者，不见而章(4)，不动而变，无为而成。',
                '天地之道，可一言(5)而尽也。其为物不贰(6)，则其生物不测。',
                '天地之道，博也、厚也、高也、明也、悠也、久也。',
                '今夫天斯昭昭之多(7)，及其无穷也，日月星辰系焉，万物覆焉。今夫地一撮土之多，及其广厚载华岳(8)而不重，振(9)河海而不洩，万物载焉。今夫山一卷(10石之多，及其广大，草木生之，禽兽居之，宝藏兴焉。今夫水，一勺之多，及其不测(11)，鼋、鼍、蛟、龙、鱼、鳖生焉，货财殖焉。',
                '诗云，“维天之命，於穆不已。”盖曰，天之所以为天也。“於乎不显，文王之德之纯。”(12)盖曰，文王之所以为文也。纯亦不已。',
            ],
            'notes' => [
                '(1)息：止息，休止。',
                '(2)征：征验，显露于外。',
