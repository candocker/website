...
return [
    ...
    'chapters' => [
        [
            'content' => [
                '子曰，“无忧者，其惟文王(1)乎。以王季(2)为父，以武王(3)为子。父作之(4)，子述之(5)。”',
                '“武王缵大王(6)、王季、文王之绪(7)。壹戎衣(8)，而有天下。身不失天下之显名。尊为天子。富有四海之内。宗庙飨之。子孙保之。”',
                '“武王末(9)受命，周公(10)成文武之德。追王大、王季(11)，上祀先公以天子之礼。斯礼也，达乎诸侯大夫(12)，及士庶人(13)。父为大夫，子为士；葬以大夫，祭以士。父为士，子为大夫；葬以士，祭以大夫。期之丧(14)，达乎大夫；三年之丧，达乎天子；父母之丧，无贵贱，一也。”',
            ],
            'notes' => [
            ...
            'vernacular' => [
                '孔子说：“古代帝王中无忧无虑的，大概只有周文王吧！因为他有贤明的王季做父亲，有英勇的武王做儿子，父亲王季为他开创了基业，儿子周武王继承他的遗志，完成了他所没有完成的事业。',
