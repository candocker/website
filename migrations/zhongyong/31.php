...
return [
    ...
    'chapters' => [
        [
            'content' => [
                '唯天下至圣，为能聪、明、睿知(1)、足以有临(2)也；宽、裕(3)、温、柔、足以有容(4)也；发、强(5)、刚、毅、足以有执(6)也；齐、庄、中、正(7)、足以有敬也；文、理、密、察(8)、足以有别(9)也。',
                '溥博，渊泉，而时出之(10)。',
                '溥博如天；渊泉如渊。见(11)而民莫不敬；言而民莫不信；行而民莫不说(12)。',
                '是以声名洋溢(13)乎中国，施及蛮貊(14)。舟车所至，人力所通，天之所覆，地之所载，日月所照，霜露所队(15)：凡有血气者莫不尊亲(16)。故曰，“配天”。',
            ],
            'notes' => [
