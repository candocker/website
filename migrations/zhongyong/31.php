...
return [
    ...
    'chapters' => [
        [
            ...
            'notes' => [
                '(1)睿（rui）知：聪明智慧。知，通“智”。(2)有临：居上临下。临，本指高处朝向低处，后引申为上对下之称。《论语·为政》：“临之以庄，则敬。”(3)宽裕：宽，广大。裕，舒缓。(4)有容：容纳，包容。(5)发强：发，奋发。强，勇力。(6)有执：操持决断天下大事。(7)齐庄：恭敬庄重。中正：不偏不倚。(8)文理：条理。密察：详察细辨。(9)有别：辨别是非正邪。(10)溥愽渊泉：溥愽：辽阔广大。溥，普遍，辽阔。渊泉，深潭。《列子·黄帝》：“心如渊泉，形如处女。”后引申为思虑深远。而时出之：出，溢出。(11)见（xian）：表现。指仪容。(12)说：通“悦”，喜悦。(13)洋溢：广泛传播。(14)施及蛮貊：施及，蔓延，传到。蛮貊，古代两个边远部族的名称。(15)队：通“坠”，坠落。(16)尊亲：尊重亲近。',
            ],
            'vernacular' => [
