...
return [
    ...
    'chapters' => [
        [
            ...
            'notes' => [
                '太史公：太史公不是自称，也不是公职，汉代只有太史令一职，且古人写信不可能自称公。钱穆在《太史公考证》一文中认为，《史记》原名是《太史公》。牛马走：谦词，意为象牛马一样以供奔走。走，义同“仆”。此十二字《汉书·司马迁传》无，据《文选》补。意思是司马迁为了《史记》一书像做牛做马一样活着。本词条基本上依照《昭明文选》李善注本，并参照无臣注本及汉书。',
                '曩：从前。',
                '望：怨。',
                '流：流转、迁移的意思。',
