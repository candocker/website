...
return [
    ...
    'chapters' => [
        [
            ...
            'notes' => [
                '(1)先进：指先学习礼乐而后再做官的人。(2)野人：朴素粗鲁的人或指乡野平民。(3)后进：先做官后学习礼乐的人。(4)君子：这里指统治者。',
            ],
            'vernacular' => [
        ...
        [
            ...
            'notes' => [
                '(1)陈、蔡：均为国名。(2)不及门：门，这里指受教的场所。不及门，是说不在跟前受教。',
            ],
            'vernacular' => [
        ...
        [
            ...
            'notes' => [
                '(1)德行：指能实行孝悌、忠恕等道德。(2)言语：指善于辞令，能办理外交。(3)政事：指能从事政治事务。(4)文学：指通晓诗书礼乐等古代文献。',
            ],
            'vernacular' => [
        ...
        [
            ...
            'notes' => [
                '(1)颜路：“颜无繇（ｙóｕ），字路，颜渊的父亲，也是孔子的学生，生于公元前545年。(2)椁：音ｇｕǒ，古人所用棺材，内为棺，外为椁。(3)鲤：孔子的儿子，字伯鲁，死时50岁，孔子70岁。(4)从大夫之后：跟随在大夫们的后面，意即当过大夫。孔子在鲁国曾任司寇，是大夫一级的官员。',
            ],
            'vernacular' => [
        ...
        [
            ...
            'notes' => [
                '(1)恸：哀伤过度，过于悲痛。(2)夫：音ｆú，指示代词，此处指颜渊。',
            ],
            'vernacular' => [
        ...
        [
            ...
            'notes' => [
                '(1)厚葬：隆重地安葬。(2)予不得视犹子也：我不能把他当亲生儿子一样看待。(3)夫：语助词。',
            ],
            'vernacular' => [
        ...
        [
            ...
            'notes' => [
                '(1)訚訚：音ｙíｎ，和颜悦色的样子。(2)行行：音ｈàｎｇ，刚强的样子。(3)侃侃：说话理直气壮。',
            ],
            'vernacular' => [
        ...
        [
            ...
            'notes' => [
                '(1)鲁人：这里指鲁国的当权者。这就是人和民的区别。(2)为长府：为，这里是改建的意思。藏财货、兵器等的仓库叫“府”，长府是鲁国的国库名。(3)仍旧贯：贯：事，例。沿袭老样子。(4)夫人：夫，音ｆú，这个人。',
            ],
            'vernacular' => [
        ...
        [
            ...
            'notes' => [
                '(1)瑟：音ｓè，一种古乐器，与古琴相似。(2)奚为于丘之门：奚，为什么。为，弹。为什么在我这里弹呢？(3)升堂入室：堂是正厅，室是内室，用以形容学习程度的深浅。',
            ],
            'vernacular' => [
        ...
        [
            ...
            'notes' => [
                '(1)师与商：师，颛孙师，即子张。商，卜商，即子夏。(2)愈：胜过，强些。',
            ],
            'vernacular' => [
        ...
        [
            ...
            'notes' => [
                '(1)季氏富于周公：季氏比周朝的公侯还要富有。(2)聚敛：积聚和收集钱财，即搜刮。(3)益：增加。',
            ],
            'vernacular' => [
        ...
        [
            ...
            'notes' => [
                '(1)柴：高柴，字子羔，孔子学生，比孔子小30岁，公元前521年出生。(2)愚：旧注云：愚直之愚，指愚而耿直，不是傻的意思。(3)鲁：迟钝。(4)辟：音ｐì，偏，偏激，邪。(5)喭：音ｙàｎ，鲁莽，粗鲁，刚猛。',
            ],
            'vernacular' => [
        ...
        [
            ...
            'notes' => [
                '(1)庶：庶几，相近。这里指颜渊的学问道德接近于完善。(2)空：贫困、匮乏。(3)货殖：做买卖。(4)亿：同“臆”，猜测，估计。',
            ],
            'vernacular' => [
        ...
        [
            ...
            'notes' => [
                '(1)善人：指本质善良但没有经过学习的人。(2)践迹：迹，脚印。踩着前人的脚印走。(3)入于室：比喻学问和修养达到了精深地步。',
            ],
            'vernacular' => [
        ...
        [
            ...
            'notes' => [
                '(1)季子然：鲁国季氏的同族人。(2)曾：乃。(3)具臣：普通的臣子。(4)之：代名词，这里指季氏。当时冉求和子路都是季氏的家臣。',
            ],
            'vernacular' => [
        ...
        [
            ...
            'notes' => [
                '(1)贼：害。(2)夫人之子：指子羔。孔子认为他没有经过很好的学习就去从政，这会害了他自己的。(3)社稷：社，土地神。稷，谷神。这里“社稷”指祭祀土地神和谷神的地方，即社稷坛。古代国都及各地都设立社稷坛，分别由国君和地方长官主祭，故社稷成为国家政权的象征。',
            ],
            'vernacular' => [
        ...
        [
            ...
            'notes' => [
                '(1)曾皙：名点，字子皙，曾参的父亲，也是孔子的学生。(2)以吾一日长乎尔，毋以也：虽然我比你们的年龄稍长一些，而不敢说话。(3)居：平日。(4)则何以哉：何以，即何以为用。(5)率尔：轻率、急切。(6)摄：迫于、夹于。(7)比及：比，音ｂì。等到。(8)方：方向。(9)哂：音ｓｈěｎ，讥讽地微笑。(10)方六七十：纵横各六七十里。(11)如：或者。(12)宗庙之事：指祭祀之事。(13)会同：诸侯会见。(14)瑞章甫：端，古代礼服的名称。章甫，古代礼帽的名称。(15)相：赞礼人，司仪。(16)希：同“稀”，指弹瑟的速度放慢，节奏逐渐稀疏。(17)作：站起来。(18)莫：同“暮”。(19)冠者：成年人。古代子弟到20岁时行冠礼，表示已经成年。(20)浴觉沂：沂，水名，发源于山东南部，流经江苏北部入海。在水边洗头面手足。(21)舞雩：雩，音ｙú。地名，原是祭天求雨的地方，在今山东曲阜。(22)唯：语首词，没有什么意义。',
            ],
            'vernacular' => [
