...
return [
    ...
    'chapters' => [
        ...
        [
            'content' => [
                '司马牛问“仁”。子曰：“仁者，其言也訒。”曰：“斯言也訒，其谓之仁矣乎？”子曰：“为之难，言之得无訒乎？”',
            ],
            'notes' => [
                '(1)司马牛：姓司马名耕，字子牛，孔子的学生。(2)讱：音ｒèｎ，话难说出口。这里引申为说话谨慎。(3)斯：就。',
            ],
            'vernacular' => [
        ...
        [
            ...
            'notes' => [
                '(1)浸润之谮，谮，音ｚèｎ，谗言。这是说像水那样一点一滴地渗进来的谗言，不易觉察。(2)肤受之愬：愬，音ｓù，诬告。这是说像皮肤感觉到疼痛那样的诬告，即直接的诽谤。(3)远：明之至，明智的最高境界。',
            ],
            'vernacular' => [
        ...
        [
            ...
            'notes' => [
                '(1)棘子成：卫国大夫。古代大夫都可以被尊称为夫子，所以子贡这样称呼他。(2)驷不及舌：指话一说出口，就收不回来了。驷，拉一辆车的四匹马。(3)鞟：音ｋｕò，去掉毛的皮，即革。',
            ],
            'vernacular' => [
        ...
        [
            ...
            'notes' => [
                '(1)盍彻乎：盍，何不。彻，西周奴隶主国家的一种田税制度。旧注曰：“什一而税谓之彻。”(2)二：抽取十分之二的税。',
            ],
            'vernacular' => [
        ...
        [
            'content' => [
                '子张问“崇德，辨惑。”子曰：“主忠信，徒义崇德也。爱之欲其生，恶之欲其死；既欲其生又欲其死，是惑也！”（诚不以富，亦只以异。）',
            ],
            'notes' => [
                '(1)崇德：提高道德修养的水平。(2)惑：迷惑，不分是非。(3)徙义：徙，迁移。向义靠扰。(4)诚不以富，亦祗以异：这是《诗经·小雅·我行其野》篇的最后两句。此诗表现了一个被遗弃的女子对其丈夫喜新厌旧的愤怒情绪。孔子在这里引此句，令人费解。',
            ],
            'vernacular' => [
        ...
        [
            ...
            'notes' => [
                '(1)片言：诉讼双方中一方的言辞，即片面之辞，古时也叫“单辞”。(2)折狱：狱，案件。即断案。(3)其由也与：大概只有仲由吧。(4)宿诺：宿，久。拖了很久而没有兑现的诺言。',
            ],
            'vernacular' => [
        ...
        [
            ...
            'notes' => [
                '(1)听讼：讼，音ｓòｎｇ，诉讼。审理诉讼案件。(2)使无讼：使人们之间没有诉讼案件之事。',
            ],
            'vernacular' => [
        ...
        [
            ...
            'notes' => [
                '(1)无道：指无道的人。(2)有道：指有道的人。(3)草上之风：指风加之于草。(4)偃：仆，倒。',
            ],
            'vernacular' => [
        ...
        [
            ...
            'notes' => [
                '(1)达：通达，显达。(2)闻：有名望。(3)下人：下，动词。对人谦恭有礼。',
            ],
            'vernacular' => [
        ...
        [
            'content' => [
                '樊迟从游於舞雩之下。曰：“敢问崇德、修慝、辨惑？”子曰：“善哉问！先事後得，非崇德与？攻其恶，无攻人之恶，非修慝与？一朝之忿，忘其身以及其亲，非惑与？”',
            ],
            'notes' => [
                '(1)修慝：慝，音ｔè，邪恶的念头。修，改正。这里是指改正邪恶的念头。(2)先事后得：先致力于事，把利禄放在后面。(3)忿：忿怒，气愤。',
            ],
            'vernacular' => [
        ...
        [
            ...
            'notes' => [
                '(1)举直错诸枉：错，同“措”，放置。诸，这是“之于”二字的合音。枉，不正直，邪恶。意为选拔直者，罢黜枉者。(2)乡：音ｘｉàｎｇ，同“向”，过去。(3)皋陶：ｇāｏｙáｏ，传说中舜时掌握刑法的大臣。(4)远：动词，远离，远去。(5)汤：商朝的第一个君主，名履。(6)伊尹：汤的宰相，曾辅助汤灭夏兴商。',
            ],
            'vernacular' => [
