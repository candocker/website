...
return [
    ...
    'chapters' => [
        [
            ...
            'notes' => [
                '(1)陈：同“阵”，军队作战时，布列的阵势。(2)俎豆：俎，音ｚǔ。俎豆是古代盛食物的器皿，被用作祭祀时的礼器。',
            ],
            'vernacular' => [
        ...
        [
            ...
            'notes' => [
                '(1)行：通达的意思。(2)蛮貊：古人对少数民族的贬称，蛮在南，貊，音ｍò，在北方。(3)州里：五家为邻，五邻为里。五党为州，二千五百家。州里指近处。(4)参：列，显现。(5)衡：车辕前面的横木。(6)绅：贵族系在腰间的大带。',
            ],
            'vernacular' => [
        ...
        [
            ...
            'notes' => [
                '(1)史鱼：卫国大夫，名，字子鱼，他多次向卫灵公推荐蘧伯玉。(2)如矢：矢，箭，形容其直。(3)卷：同“捲”。',
            ],
            'vernacular' => [
        ...
        [
            ...
            'notes' => [
                '(1)夏之时：夏代的历法，便于农业生产。(2)殷之辂：辂，音ｌù，天子所乘的车。殷代的车是木制成，比较朴实。(3)周之冕：周代的帽子。(4)韶舞：是舜时的舞乐，孔子认为是尽善尽美的。(5)放：禁绝、排斥、抛弃的意思。(6)郑声：郑国的乐曲，孔子认为是淫声。(7)远：远离。(8)殆：危险。',
            ],
            'vernacular' => [
        ...
        [
            ...
            'notes' => [
                '(1)窃位：身居官位而不称职。(2)柳下惠：春秋中期鲁国大夫，姓展名获，又名禽，他受封的地名是柳下，惠是他的私谥，所以，人称其为柳下惠。',
            ],
            'vernacular' => [
        ...
        [
            'name' => '第二十四节',
            'content' => [
                '子贡问曰：“有一言而可以终身行之者乎？”子曰：“其恕觉！己所不欲，勿施于人。”',
            ],
            'vernacular' => [
        ...
        [
            ...
            'notes' => [
                '(1)阙文：史官记史，遇到有疑问的地方便缺而不记，这叫做阙文。(2)有马者借人乘之：有人认为此句系错出，另有一种解释为：有马的人自己不会调教，而靠别人训练。本书依从后者。',
            ],
            'vernacular' => [
        ...
        [
            ...
            'notes' => [
                '(1)知及之：知，同“智”。之，一说是指百姓，一说是指国家。此处我们认为指禄位和国家天下。(2)涖：音ｌì，临，到的意思。',
            ],
            'vernacular' => [
