    ...
    'chapters' => [
        ...
        [
            ...
            'notes' => [
                ...
                '孝弟：孝，奴隶社会时期所认为的子女对待父母的正确态度；弟，读音和意义与“悌”（音tì）相同，即弟弟对待兄长的正确态度，敬爱兄长。孝、弟是孔子和儒家特别提倡的两个基本道德规范。旧注说：善事父母曰孝，善事兄长曰弟。',
                '犯上：犯，冒犯、干犯。上，指在上位的人。',
        ...
        [
            ...
            'notes' => [
                '曾子：孔子晚年的学生，比孔子小四十六岁。曾子姓曾名参（音shēn）字子舆，生于公元前505年，鲁国人，是被鲁国灭亡了的鄫国贵族的后代。曾参是孔子的得意门生，以孝子出名。据说《孝经》就是他撰写的。',
        ...
        [
            ...
            'notes' => [
                ...
                '色：脸色，态度。此处指尊重贤者，改变自己的态度。',
                '致其身：致，意为“献纳”、“尽力”。这是说能够不遗余力奉献君上。',
            ],
            'vernacular' => [
        ...
        [
            ...
            'notes' => [
                ...
                '邦：指当时割据的诸侯国家。',
                '抑：表示选择的文言连词，有“还是”的意思。与之，（别人）自愿给他。',
        ...
        [
            ...
            'notes' => [
                ...
                '其：表测度语气，可译为“大概”。',
                '赐：子贡的名。孔子对学生一般都称名。',
                '告诸往而知来者：诸，同之；往，过去的事情；来者：未来的事，这里借喻为未知的事。',
            ],
            'vernacular' => [
