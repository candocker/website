...
return [
    'name' => '微子',
    'brief' => '记录古代圣贤事迹、孔子众人周游列国中的言行及周游途中世人对于乱世的看法',
    'chapters' => [
        [
            'name' => '第一节',
            'content' => [
            ...
            'notes' => [
                '(1)微子：殷纣王的同母兄长，见纣王无道，劝他不听，遂离开纣王。(2)箕子：箕，音ｊī。殷纣王的叔父。他去劝纣王，见王不听，便披发装疯，被降为奴隶。(3)比干：殷纣王的叔父，屡次强谏，激怒纣王而被杀。',
            ],
            'vernacular' => [
        ...
        [
            'name' => '第五节',
            'content' => [
                '楚狂接舆(1)歌而过孔子曰：“凤兮凤兮！疚德之衰？往者不可谏，来者犹可追。已而已而！今之从政者殆而！”孔子下，欲与之言。趋而辟之，不得与之言。',
            ],
            'notes' => [
        ...
        [
            ...
            'notes' => [
                '(1)长沮、桀溺：两位隐士，真实姓名和身世不详。(2)耦而耕：两个人合力耕作。(3)问津：津，渡口。寻问渡口。(4)执舆：即执辔。(5)之：与。(6)辟：同“避”。(7)耰：音ｙōｕ，用土覆盖种子。(8)怃然：怅然，失意。',
            ],
            'vernacular' => [
        ...
        [
            ...
            'notes' => [
                '(1)蓧：音ｄｉàｏ，古代耘田所用的竹器。(2)四体不勤，五谷不分：一说这是丈人指自己。分是粪；不，是语气词，意为：我忙于播种五谷，没有闲暇，怎知你夫子是谁？另一说是丈人责备子路。说子路手脚不勤，五谷不分。多数人持第二种说法。我们以为，子路与丈人刚说了一句话，丈人并不知道子路是否真的四体不勤，五谷不分，没有可能说出这样的话。所以，我们同意第一种说法。(3)黍：音ｓｈǔ，黏小米。(4)食：音ｓì，拿东西给人吃。',
            ],
            'vernacular' => [
        ...
        [
            ...
            'notes' => [
                '(1)逸：同“佚”，散失、遗弃。(2)虞仲、夷逸、朱张、少连：此四人身世无从考，从文中意思看，当是没落贵族。(3)放：放置，不再谈论世事。',
            ],
            'vernacular' => [
        ...
        [
            ...
            'notes' => [
                '(1)大师挚：大同“太”。太师是鲁国乐官之长，挚是人名。(2)亚饭、三饭、四饭：都是乐官名。干、缭、缺是人名。(3)鼓方叔：击鼓的乐师名方叔。(4)鼗：音ｔáｏ，小鼓。(5)少师：乐官名，副乐师。(6)击磬襄：击磬的乐师，名襄。',
            ],
            'vernacular' => [
        ...
        [
            ...
            'notes' => [
                '(1)鲁公：指周公的儿子伯禽，封于鲁。(2)施：同“弛”，怠慢、疏远。(3)以：用。',
            ],
            'vernacular' => [
